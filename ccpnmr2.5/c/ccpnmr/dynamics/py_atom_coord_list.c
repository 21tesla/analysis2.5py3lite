...
static Py_Atom_coord_list new_py_atom_coord_list(void)
{
    ...
    py_atom_coord_list = (Py_Atom_coord_list) PyObject_New(struct Py_Atom_coord_list, &Atom_coord_list_type);
...
static PyObject *getattr_py_atom_coord_list(PyObject *self, PyObject *attr_name)
{
/*
    Py_Atom_coord_list obj = (Py_Atom_coord_list) self;
...
static int setattr_py_atom_coord_list(PyObject *self, PyObject *attr_name, PyObject *value)
{
/*
    Py_Atom_coord_list obj = (Py_Atom_coord_list) self;
    Atom_coord_list atom_coord_list = obj->atom_coord_list;
...
static PyTypeObject Atom_coord_list_type =
{
    ...
    "AtomCoordList",                        /* tp_name */
    sizeof(struct Py_Atom_coord_list),      /* tp_basicsize */
    0,                                      /* tp_itemsize */
    (destructor) delete_py_atom_coord_list, /* tp_dealloc */
    0,                                      /* tp_vectorcall */
    0,                                      /* tp_getattr */
    0,                                      /* tp_setattr */
    0,                                      /* tp_as_async */
    ...
    0,                                      /* tp_call */
    0,                                      /* tp_str */
    (getattrofunc) getattr_py_atom_coord_list,  /* tp_getattro */
    (setattrofunc) setattr_py_atom_coord_list,  /* tp_setattro */
    0,                                      /* tp_as_buffer */
    Py_TPFLAGS_DEFAULT,                     /* tp_flags */
    "AtomCoordList -- list of atom coordinates", /* tp_doc */
    0,                                      /* tp_traverse */
    0,                                      /* tp_clear */
    0,                                      /* tp_richcompare */
    0,                                      /* tp_weaklistoffset */
...
static struct PyModuleDef DyAtomCoordList_module_def =
{
    PyModuleDef_HEAD_INIT,
    "DyAtomCoordList",
    "CCPNMR DyAtomCoordList module (Python 3 compatible)",
    -1,
    Atom_coord_list_type_methods
};

PyMODINIT_FUNC PyInit_DyAtomCoordList(void)
{
    if (PyType_Ready(&Atom_coord_list_type) < 0)
        return NULL;

    PyObject *m = PyModule_Create(&DyAtomCoordList_module_def);
    if (!m)
        return NULL;
