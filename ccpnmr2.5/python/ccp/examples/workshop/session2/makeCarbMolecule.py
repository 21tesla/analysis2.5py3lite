...
def makeCarbMolecule(project, molName="carbMol"):
    ...
    keywds = {"molType": "carbohydrate", "ccpCode": "dglc-hex-1-5:C1_OMe:C2_NAc"}
    glcNAcOMe = project.findFirstChemComp(**keywds)

    keywds2 = {"molType": "carbohydrate", "ccpCode": "dglc-hex-1-5:C2_NAc"}
    ...
    keywds3 = {"seqCode": resNum, "chemComp": glcNAcOMe, "linking": "link:O4", "descriptor": "stereo_2:C1"}
    molRes1 = molecule.newMolResidue(**keywds3)

    resNum += 1

    keywds4 = {"seqCode": resNum, "chemComp": glcNAc, "linking": "link:C1_2", "descriptor": "stereo_2:C1"}
...
def makeCarbMolSystem(project, molecule, molSysName="carbMolSys", molSysCode="carbCode", chainCodes="A"):
    ...
    for chain in molSystem.sortedChains():
        ...
        for res in chain.sortedResidues():
            ...
            for mrle in molRes.molResLinkEnds:
                ...
                print(
                    "  Atom: [%s] linked to Residue: [%s.%s] Atom: [%s]"
