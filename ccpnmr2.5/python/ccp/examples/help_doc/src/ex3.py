...
if __name__ == "__main__":
    ...
    affStore = project.currentAffiliationStore = project.newAffiliationStore(name=project.name)
    ...
    citStore = project.currentCitationStore = project.newCitationStore(name=project.name)
