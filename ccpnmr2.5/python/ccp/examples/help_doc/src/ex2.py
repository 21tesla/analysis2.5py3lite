...
if __name__ == "__main__":
    ...
    keywds = {"title": "test title", "bmrbProcessing": "test submission", "details": "test details"}
    ...
    print("Entry [%s] [%s] [%s] [%s]\n" % (entryName, entryTitle, entryBmrbProc, entryDetails))

    # Make a second Entry with slightly different attributes.
    keywds2 = {"title": "test title2", "bmrbProcessing": "test submission", "details": "test details"}
