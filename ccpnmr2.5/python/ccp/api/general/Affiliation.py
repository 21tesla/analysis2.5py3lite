...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:28 2015
  from data model element ccp.general.Affiliation revision ?
...
class AffiliationStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.general.Affiliation.AffiliationStore revision ?
...
class Group(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Affiliation.Group revision ?
...
class Organisation(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Affiliation.Organisation revision ?
...
class Person(memops.api.Implementation.DataObject):
  ...
  _packageName = 'ccp.general.Affiliation'
  _packageShortName = 'AFFI'
  _fieldNames = ('applicationData', 'className', 'familyName', 'familyTitle', 'fieldNames', 'firstInitial', 'givenName', 'inConstructor', 'isDeleted', 'metaclass', 'middleInitials', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'title', 'access', 'activeAccess', 'affiliationStore', 'authorCitations', 'authoredEntries', 'contactEntries', 'createdExps', 'createdProtocols', 'currentPersonInGroup', 'dropAnnotations', 'editedExps', 'editedProtocols', 'editorCitations', 'expBlueprints', 'parent', 'personInGroups', 'root', 'targets', 'topObject', 'users',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: createdExps:
           non-reciprocal link createdExps from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: createdProtocols:
           non-reciprocal link createdProtocols from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: editedExps:
           non-reciprocal link editedExps from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: editedProtocols:
           non-reciprocal link editedProtocols from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
information.
  """
  #   from data model element ccp.general.Affiliation.PersonInGroup revision ?
  _metaclass = metaPackage.getElement('PersonInGroup')
  _packageName = 'ccp.general.Affiliation'
  _packageShortName = 'AFFI'
  _fieldNames = ('applicationData', 'className', 'deliveryAddress', 'emailAddress', 'endDate', 'faxNumber', 'fieldNames', 'inConstructor', 'isDeleted', 'mailingAddress', 'metaclass', 'packageName', 'packageShortName', 'phoneNumbers', 'position', 'qualifiedName', 'serial', 'access', 'activeAccess', 'group', 'parent', 'person', 'photo', 'root', 'topObject',)
