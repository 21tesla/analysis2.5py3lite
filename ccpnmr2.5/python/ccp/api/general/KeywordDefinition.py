...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:22 2015
  from data model element ccp.general.KeywordDefinition revision ?
...
class KeywordDefinition(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element ccp.general.KeywordDefinition.KeywordDefinition revision ?
  _metaclass = metaPackage.getElement('KeywordDefinition')
  _packageName = 'ccp.general.KeywordDefinition'
  _packageShortName = 'KWDF'
  _fieldNames = ('applicationData', 'className', 'explanation', 'fieldNames', 'inConstructor', 'isDeleted', 'keyword', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'targetNames', 'access', 'activeAccess', 'keywordDefinitionStore', 'parent', 'root', 'topObject',)
  ...
  allowed type for the object being described (*not* the object that 
...
program or standard). 
  """
  #   from data model element ccp.general.KeywordDefinition.KeywordDefinitionStore revision ?
  _metaclass = metaPackage.getElement('KeywordDefinitionStore')
  _packageName = 'ccp.general.KeywordDefinition'
  _packageShortName = 'KWDF'
  _fieldNames = ('applicationData', 'className', 'context', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'activeRepositories', 'keywordDefinitions', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: keywordDefinitions:
           non-reciprocal link keywordDefinitions from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
