...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:23 2015
...
class AbstractDataStore(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.DataLocation.AbstractDataStore revision ?
  _metaclass = metaPackage.getElement('AbstractDataStore')
  _packageName = 'ccp.general.DataLocation'
  _packageShortName = 'DLOC'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'fullPath', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'path', 'qualifiedName', 'serial', 'access', 'activeAccess', 'dataLocationStore', 'dataUrl', 'parent', 'root', 'topObject',)
...
class Component(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.DataLocation.Component revision ?
...
reconstruct a component.
  """
  #   from data model element ccp.general.DataLocation.ComponentShape revision ?
...
class DataLocationStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.general.DataLocation.DataLocationStore revision ?
...
class DataUrl(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.DataLocation.DataUrl revision ?
...
class MimeTypeDataStore(AbstractDataStore):
  ...
  """
  #   from data model element ccp.general.DataLocation.MimeTypeDataStore revision ?
  _metaclass = metaPackage.getElement('MimeTypeDataStore')
  _packageName = 'ccp.general.DataLocation'
  _packageShortName = 'DLOC'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'fullPath', 'inConstructor', 'isDeleted', 'metaclass', 'mimeType', 'packageName', 'packageShortName', 'path', 'qualifiedName', 'serial', 'access', 'activeAccess', 'dataLocationStore', 'dataUrl', 'nmrDataSourceImage', 'parent', 'photoPersons', 'root', 'topObject',)
  ...
  def addPhotoPerson(self, value):
    ...
    """
    dataDict = self.__dict__
    from ccp.api.general.Affiliation import PersonInGroup as importedType
    if (not isinstance(value, importedType)):
...
header size refers to the header of the entire dataasource.
  """
  #   from data model element ccp.general.DataLocation.ShapeMatrix revision ?
