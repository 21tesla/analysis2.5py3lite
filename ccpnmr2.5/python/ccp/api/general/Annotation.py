...
class Annotation(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Annotation.Annotation revision ?
...
class AnnotationStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.general.Annotation.AnnotationStore revision ?
...
sequence, or a simple comment for a particular residue.
  """
  #   from data model element ccp.general.Annotation.MolFeature revision ?
