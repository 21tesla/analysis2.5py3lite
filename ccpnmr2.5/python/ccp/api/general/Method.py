...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:49 2015
  from data model element ccp.general.Method revision ?
...
processing) or real-world (e.g. purification).
  """
  #   from data model element ccp.general.Method.Method revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: columns:
           non-reciprocal link columns from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: compressDataSources:
           non-reciprocal link compressDataSources from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: dataDerivations:
           non-reciprocal link dataDerivations from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: derivedNmrExperiments:
           non-reciprocal link derivedNmrExperiments from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: fitPeakLists:
           non-reciprocal link fitPeakLists from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: intensPeakLists:
           non-reciprocal link intensPeakLists from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: measurements:
           non-reciprocal link measurements from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: peakIntensities:
           non-reciprocal link peakIntensities from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: processDataSources:
           non-reciprocal link processDataSources from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: snDataSources:
           non-reciprocal link snDataSources from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class MethodStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.general.Method.MethodStore revision ?
...
class Parameter(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Method.Parameter revision ?
...
class Software(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.general.Method.Software revision ?
  _metaclass = metaPackage.getElement('Software')
  _packageName = 'ccp.general.Method'
  _packageShortName = 'METH'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'tasks', 'vendorAddress', 'vendorName', 'vendorWebAddress', 'version', 'access', 'activeAccess', 'citations', 'dropAnnotations', 'entries', 'methodStore', 'methods', 'parent', 'root', 'topObject', 'validationStores',)
