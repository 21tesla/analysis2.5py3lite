...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:43 2015
  from data model element ccp.general.Instrument revision ?
...
experiment.
  """
  #   from data model element ccp.general.Instrument.AbstractInstrument revision ?
...
class InstrumentStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.general.Instrument.InstrumentStore revision ?
...
class NmrProbe(AbstractInstrument):
  r"""NMR probe used. 
  """
  #   from data model element ccp.general.Instrument.NmrProbe revision ?
...
class NmrSpectrometer(AbstractInstrument):
  ...
  """
  #   from data model element ccp.general.Instrument.NmrSpectrometer revision ?
...
class Instrument(AbstractInstrument):
  r"""Instrument used.
  """
  #   from data model element ccp.general.Instrument.Instrument revision ?
...
class Column(Instrument):
  ...
  """
  #   from data model element ccp.general.Instrument.Column revision ?
