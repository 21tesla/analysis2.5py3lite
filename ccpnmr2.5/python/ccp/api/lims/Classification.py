...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:26 2015
  from data model element ccp.lims.Classification revision ?
...
class AbstractCategory(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Classification.AbstractCategory revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: experimentTypes:
           non-reciprocal link experimentTypes from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: hazardPhrases:
           non-reciprocal link hazardPhrases from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: holderCategorys:
           non-reciprocal link holderCategorys from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: targetScoreboards:
           non-reciprocal link targetScoreboards from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
caregories include buffering agent, salt, inhibitor,...
  """
  #   from data model element ccp.lims.Classification.SampleComponentCategory revision ?
...
organisations can have their own types.
  """
  #   from data model element ccp.lims.Classification.ExperimentType revision ?
...
class TargetScoreboard(AbstractCategory):
  ...
  """
  #   from data model element ccp.lims.Classification.TargetScoreboard revision ?
...
organisations can have their own categories.
  """
  #   from data model element ccp.lims.Classification.HolderCategory revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: abstractHolderTypes:
           non-reciprocal link abstractHolderTypes from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class HazardPhrase(AbstractCategory):
  ...
  """
  #   from data model element ccp.lims.Classification.HazardPhrase revision ?
...
specific to a particular organisation.
  """
  #   from data model element ccp.lims.Classification.InstrumentType revision ?
...
organisations can have their own categories.
  """
  #   from data model element ccp.lims.Classification.SampleCategory revision ?
...
class TargetStatus(AbstractCategory):
  ...
  """
  #   from data model element ccp.lims.Classification.TargetStatus revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: blueprintStatuss:
           non-reciprocal link blueprintStatuss from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
