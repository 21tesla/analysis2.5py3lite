...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:26:17 2015
  from data model element ccp.lims.Protocol revision ?
...
values are associated with an Experiment.
  """
  #   from data model element ccp.lims.Protocol.ParameterDefinition revision ?
  _metaclass = metaPackage.getElement('ParameterDefinition')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'className', 'defaultValue', 'displayUnit', 'fieldNames', 'inConstructor', 'isDeleted', 'label', 'mandatory', 'maxValue', 'metaclass', 'minValue', 'name', 'packageName', 'packageShortName', 'paramType', 'possibleValues', 'qualifiedName', 'serial', 'unit', 'access', 'activeAccess', 'parameters', 'parent', 'protocol', 'root', 'step', 'topObject',)
...
class Procedure(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Protocol.Procedure revision ?
  _metaclass = metaPackage.getElement('Procedure')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'numCycles', 'packageName', 'packageShortName', 'procNumber', 'qualifiedName', 'remarks', 'role', 'serial', 'access', 'activeAccess', 'instrumentTypes', 'parent', 'protocol', 'root', 'steps', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: instrumentTypes:
           non-reciprocal link instrumentTypes from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: steps:
           non-reciprocal link steps from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
that contain steps.
  """
  #   from data model element ccp.lims.Protocol.Protocol revision ?
  _metaclass = metaPackage.getElement('Protocol')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'className', 'creationDate', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'lastEditedDate', 'metaclass', 'name', 'objective', 'packageName', 'packageShortName', 'qualifiedName', 'remarks', 'serial', 'access', 'activeAccess', 'creator', 'experimentType', 'experiments', 'lastEditor', 'parameterDefinitions', 'parent', 'procedures', 'protocolStore', 'refInputSamples', 'refOutputSamples', 'references', 'root', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      if (value is not None):
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: creator:
           non-reciprocal link creator from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      if (value is not None):
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: lastEditor:
           non-reciprocal link lastEditor from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: parameterDefinitions:
           non-reciprocal link parameterDefinitions from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: procedures:
           non-reciprocal link procedures from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: references:
           non-reciprocal link references from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class ProtocolStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.lims.Protocol.ProtocolStore revision ?
  _metaclass = metaPackage.getElement('ProtocolStore')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'activeRepositories', 'memopsRoot', 'packageLocator', 'parent', 'protocols', 'root', 'topObject',)
...
InputSampleDef.sampleCategory is null).
  """
  #   from data model element ccp.lims.Protocol.RefInputSample revision ?
  _metaclass = metaPackage.getElement('RefInputSample')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('amount', 'applicationData', 'className', 'displayUnit', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'unit', 'access', 'activeAccess', 'addSteps', 'inputSamples', 'parent', 'protocol', 'refSample', 'root', 'solAflowSteps', 'solBflowSteps', 'step', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: addSteps:
           non-reciprocal link addSteps from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: solAflowSteps:
           non-reciprocal link solAflowSteps from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: solBflowSteps:
           non-reciprocal link solBflowSteps from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
OutputSampleDef.sampleCategory is null).
  """
  #   from data model element ccp.lims.Protocol.RefOutputSample revision ?
  _metaclass = metaPackage.getElement('RefOutputSample')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('amount', 'applicationData', 'className', 'displayUnit', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'unit', 'access', 'activeAccess', 'outputSamples', 'parent', 'protocol', 'refSample', 'root', 'step', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: outputSamples:
           non-reciprocal link outputSamples from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
certain time (duration).
  """
  #   from data model element ccp.lims.Protocol.Step revision ?
  _metaclass = metaPackage.getElement('Step')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'className', 'details', 'duration', 'durationDisplayUnit', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'role', 'serial', 'stepNumber', 'access', 'activeAccess', 'parameterDefinitions', 'parent', 'procedure', 'refInputSamples', 'refOutputSamples', 'root', 'topObject',)
...
class CentrifugationStep(Step):
  ...
  """
  #   from data model element ccp.lims.Protocol.CentrifugationStep revision ?
  _metaclass = metaPackage.getElement('CentrifugationStep')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'centrifugationSpeed', 'centrifugeModel', 'className', 'details', 'distFromAxis', 'duration', 'durationDisplayUnit', 'fieldNames', 'gnum', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'role', 'serial', 'stepNumber', 'tempDisplayUnit', 'temperature', 'access', 'activeAccess', 'parameterDefinitions', 'parent', 'procedure', 'refInputSamples', 'refOutputSamples', 'root', 'topObject',)
...
class FiltrationStep(Step):
  ...
  """
  #   from data model element ccp.lims.Protocol.FiltrationStep revision ?
  _metaclass = metaPackage.getElement('FiltrationStep')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'className', 'details', 'duration', 'durationDisplayUnit', 'fieldNames', 'inConstructor', 'isDeleted', 'memCutoffDisplayUnit', 'membraneCutoff', 'membraneName', 'metaclass', 'methodName', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'role', 'serial', 'stepNumber', 'tempDisplayUnit', 'temperature', 'access', 'activeAccess', 'parameterDefinitions', 'parent', 'procedure', 'refInputSamples', 'refOutputSamples', 'root', 'topObject',)
...
class PressStep(Step):
  r"""Press step.
  """
  #   from data model element ccp.lims.Protocol.PressStep revision ?
  _metaclass = metaPackage.getElement('PressStep')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'className', 'details', 'duration', 'durationDisplayUnit', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'pressure', 'pressureDisplayUnit', 'qualifiedName', 'role', 'serial', 'stepNumber', 'tempDisplayUnit', 'temperature', 'access', 'activeAccess', 'parameterDefinitions', 'parent', 'procedure', 'refInputSamples', 'refOutputSamples', 'root', 'topObject',)
...
class WaitStep(Step):
  r"""Step for waiting.
  """
  #   from data model element ccp.lims.Protocol.WaitStep revision ?
  _metaclass = metaPackage.getElement('WaitStep')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'className', 'details', 'duration', 'durationDisplayUnit', 'fieldNames', 'inConstructor', 'isDeleted', 'location', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'role', 'serial', 'stepNumber', 'tempDisplayUnit', 'temperature', 'access', 'activeAccess', 'parameterDefinitions', 'parent', 'procedure', 'refInputSamples', 'refOutputSamples', 'root', 'topObject',)
...
class AddStep(Step):
  ...
  """
  #   from data model element ccp.lims.Protocol.AddStep revision ?
  _metaclass = metaPackage.getElement('AddStep')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('amount', 'amountDisplayUnit', 'amountUnit', 'applicationData', 'className', 'details', 'duration', 'durationDisplayUnit', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'role', 'serial', 'stepNumber', 'access', 'activeAccess', 'parameterDefinitions', 'parent', 'procedure', 'refInputSample', 'refInputSamples', 'refOutputSamples', 'root', 'topObject',)
...
class FlowStep(Step):
  r"""Flow step.
  """
  #   from data model element ccp.lims.Protocol.FlowStep revision ?
  _metaclass = metaPackage.getElement('FlowStep')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'beginProportionSolA', 'className', 'details', 'duration', 'durationDisplayUnit', 'endProportionSolA', 'fieldNames', 'flowType', 'flowrate', 'flowrateDisplayUnit', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'role', 'serial', 'stepNumber', 'access', 'activeAccess', 'parameterDefinitions', 'parent', 'procedure', 'refInputSamples', 'refOutputSamples', 'root', 'solutionA', 'solutionB', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      if (value is not None):
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: solutionA:
           non-reciprocal link solutionA from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      if (value is not None):
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: solutionB:
           non-reciprocal link solutionB from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class SonicationStep(Step):
  ...
  """
  #   from data model element ccp.lims.Protocol.SonicationStep revision ?
  _metaclass = metaPackage.getElement('SonicationStep')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'className', 'details', 'duration', 'durationDisplayUnit', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'probePower', 'probePulseMode', 'probeSize', 'qualifiedName', 'role', 'serial', 'stepNumber', 'tempDisplayUnit', 'temperature', 'access', 'activeAccess', 'parameterDefinitions', 'parent', 'procedure', 'refInputSamples', 'refOutputSamples', 'root', 'topObject',)
...
class TemperatureStep(Step):
  r"""Temperature step.
  """
  #   from data model element ccp.lims.Protocol.TemperatureStep revision ?
  _metaclass = metaPackage.getElement('TemperatureStep')
  _packageName = 'ccp.lims.Protocol'
  _packageShortName = 'PROT'
  _fieldNames = ('applicationData', 'className', 'details', 'duration', 'durationDisplayUnit', 'fieldNames', 'finalTemperature', 'inConstructor', 'initialTemperature', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'role', 'serial', 'stepNumber', 'tempDisplayUnit', 'access', 'activeAccess', 'parameterDefinitions', 'parent', 'procedure', 'refInputSamples', 'refOutputSamples', 'root', 'topObject',)
