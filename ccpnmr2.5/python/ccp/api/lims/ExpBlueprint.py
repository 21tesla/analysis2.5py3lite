...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:26:20 2015
  from data model element ccp.lims.ExpBlueprint revision ?
...
class BlueprintComponent(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.ExpBlueprint.BlueprintComponent revision ?
  _metaclass = metaPackage.getElement('BlueprintComponent')
  _packageName = 'ccp.lims.ExpBlueprint'
  _packageShortName = 'EXPB'
  _fieldNames = ('alwaysIncluded', 'applicationData', 'approxBeginSeqId', 'approxEndSeqId', 'className', 'componentType', 'details', 'domain', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'status', 'whyChosen', 'access', 'activeAccess', 'expBlueprint', 'molComponent', 'parent', 'root', 'sampleComponents', 'target', 'topObject', 'trialMolComponents',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: trialMolComponents:
           non-reciprocal link trialMolComponents from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class BlueprintDbRef(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.ExpBlueprint.BlueprintDbRef revision ?
  _metaclass = metaPackage.getElement('BlueprintDbRef')
  _packageName = 'ccp.lims.ExpBlueprint'
  _packageShortName = 'EXPB'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'access', 'activeAccess', 'dbRef', 'expBlueprint', 'parent', 'root', 'topObject',)
...
class BlueprintStatus(memops.api.Implementation.DataObject):
  ...
  _packageName = 'ccp.lims.ExpBlueprint'
  _packageShortName = 'EXPB'
  _fieldNames = ('applicationData', 'className', 'date', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'access', 'activeAccess', 'code', 'expBlueprint', 'experiment', 'parent', 'root', 'topObject',)
...
of wish targets and non-polymer molecules.
  """
  #   from data model element ccp.lims.ExpBlueprint.ExpBlueprint revision ?
  _metaclass = metaPackage.getElement('ExpBlueprint')
  _packageName = 'ccp.lims.ExpBlueprint'
  _packageShortName = 'EXPB'
  _fieldNames = ('applicationData', 'biochemicalFunction', 'biologicalProcess', 'catalyticActivity', 'cellLocation', 'className', 'commonName', 'details', 'fieldNames', 'functionDescription', 'inConstructor', 'isDeleted', 'localName', 'metaclass', 'packageName', 'packageShortName', 'pathway', 'qualifiedName', 'serial', 'similarityDetails', 'systematicName', 'whyChosen', 'access', 'activeAccess', 'blueprintComponents', 'blueprintDbRefs', 'blueprintStatuses', 'expBlueprintStore', 'experiments', 'owner', 'parent', 'root', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: blueprintStatuses:
           non-reciprocal link blueprintStatuses from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      if (value is not None):
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: owner:
           non-reciprocal link owner from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class ExpBlueprintStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.lims.ExpBlueprint.ExpBlueprintStore revision ?
  _metaclass = metaPackage.getElement('ExpBlueprintStore')
  _packageName = 'ccp.lims.ExpBlueprint'
  _packageShortName = 'EXPB'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'activeRepositories', 'expBlueprints', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: expBlueprints:
           non-reciprocal link expBlueprints from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
