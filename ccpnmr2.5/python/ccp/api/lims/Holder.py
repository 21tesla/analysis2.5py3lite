...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:42 2015
  from data model element ccp.lims.Holder revision ?
...
class AbstractHolderType(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Holder.AbstractHolderType revision ?
  _metaclass = metaPackage.getElement('AbstractHolderType')
  _packageName = 'ccp.lims.Holder'
  _packageShortName = 'HOLD'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'holderCategories', 'holderStore', 'parent', 'root', 'topObject',)
...
group holder together.
  """
  #   from data model element ccp.lims.Holder.Holder revision ?
  _metaclass = metaPackage.getElement('Holder')
  _packageName = 'ccp.lims.Holder'
  _packageShortName = 'HOLD'
  _fieldNames = ('applicationData', 'className', 'colPosition', 'details', 'endDate', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'rowPosition', 'startDate', 'subPosition', 'access', 'activeAccess', 'contents', 'holder', 'holderCategories', 'holderLocations', 'holderStore', 'holderType', 'parent', 'refSamplePositions', 'root', 'samples', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: holderCategories:
           non-reciprocal link holderCategories from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: holderLocations:
           non-reciprocal link holderLocations from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class HolderLocation(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Holder.HolderLocation revision ?
  _metaclass = metaPackage.getElement('HolderLocation')
  _packageName = 'ccp.lims.Holder'
  _packageShortName = 'HOLD'
  _fieldNames = ('applicationData', 'className', 'endDate', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'startDate', 'access', 'activeAccess', 'holder', 'location', 'parent', 'root', 'topObject',)
...
class HolderStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.lims.Holder.HolderStore revision ?
  _metaclass = metaPackage.getElement('HolderStore')
  _packageName = 'ccp.lims.Holder'
  _packageShortName = 'HOLD'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'activeRepositories', 'holderTypes', 'holders', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: holderTypes:
           non-reciprocal link holderTypes from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: holders:
           non-reciprocal link holders from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class HolderTypePosition(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Holder.HolderTypePosition revision ?
  _metaclass = metaPackage.getElement('HolderTypePosition')
  _packageName = 'ccp.lims.Holder'
  _packageShortName = 'HOLD'
  _fieldNames = ('applicationData', 'className', 'colPosition', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'maxVolume', 'maxVolumeDiplayUnit', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'rowPosition', 'serial', 'subPosition', 'access', 'activeAccess', 'holderType', 'parent', 'root', 'topObject',)
...
class RefSamplePosition(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element ccp.lims.Holder.RefSamplePosition revision ?
  _metaclass = metaPackage.getElement('RefSamplePosition')
  _packageName = 'ccp.lims.Holder'
  _packageShortName = 'HOLD'
  _fieldNames = ('applicationData', 'className', 'colPosition', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'rowPosition', 'serial', 'subPosition', 'access', 'activeAccess', 'holder', 'parent', 'refSample', 'root', 'topObject',)
...
class PinType(AbstractHolderType):
  ...
  """
  #   from data model element ccp.lims.Holder.PinType revision ?
  _metaclass = metaPackage.getElement('PinType')
  _packageName = 'ccp.lims.Holder'
  _packageShortName = 'HOLD'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'length', 'loopLength', 'loopType', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'wireWidth', 'access', 'activeAccess', 'holderCategories', 'holderStore', 'parent', 'root', 'topObject',)
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    ...
    for holder in self.holderStore.findAllHolders(holderType=self):
      holder.holderType = None
    if (not ((dataDict.get('topObject').__dict__.get('isLoaded') or dataDict.get('topObject').__dict__.get('isReading')))):
      dataDict.get('topObject').load()
...
rather than A1.
  """
  #   from data model element ccp.lims.Holder.HolderType revision ?
  _metaclass = metaPackage.getElement('HolderType')
  _packageName = 'ccp.lims.Holder'
  _packageShortName = 'HOLD'
  _fieldNames = ('applicationData', 'className', 'details', 'fieldNames', 'holdHolderFlag', 'inConstructor', 'isDeleted', 'maxColumn', 'maxRow', 'maxSubPosition', 'maxVolume', 'maxVolumeDisplayUnit', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'holderCategories', 'holderStore', 'holderTypePositions', 'parent', 'root', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: holderTypePositions:
           non-reciprocal link holderTypePositions from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
