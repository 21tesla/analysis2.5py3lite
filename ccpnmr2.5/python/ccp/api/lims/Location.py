...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:34 2015
...
class Location(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Location.Location revision ?
...
class LocationStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.lims.Location.LocationStore revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: locations:
           non-reciprocal link locations from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
