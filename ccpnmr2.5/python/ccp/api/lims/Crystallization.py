...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:26:17 2015
  from data model element ccp.lims.Crystallization revision ?
...
class CrystallizationStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.lims.Crystallization.CrystallizationStore revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: images:
           non-reciprocal link images from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: scoringSchemes:
           non-reciprocal link scoringSchemes from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class DropAnnotation(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element ccp.lims.Crystallization.DropAnnotation revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      if (not (self in oldSelves)):
        raise ApiError("""%s.checkValid: annotator:
         non-reciprocal link annotator from object""" % self.qualifiedName
         + ": %s" % (self,)
        )
...
class Image(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element ccp.lims.Crystallization.Image revision ?
...
class Parameter(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Crystallization.Parameter revision ?
...
values are associated with an Experiment.
  """
  #   from data model element ccp.lims.Crystallization.ParameterDefinition revision ?
...
class Score(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element ccp.lims.Crystallization.Score revision ?
...
class ScoringScheme(memops.api.Implementation.DataObject):
  r"""
  """
  #   from data model element ccp.lims.Crystallization.ScoringScheme revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: scores:
           non-reciprocal link scores from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
