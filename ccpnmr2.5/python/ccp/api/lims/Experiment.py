...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:26:41 2015
  from data model element ccp.lims.Experiment revision ?
...
class Experiment(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Experiment.Experiment revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: next:
           non-reciprocal link next from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: previous:
           non-reciprocal link previous from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: sampleIos:
           non-reciprocal link sampleIos from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class ExperimentGroup(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Experiment.ExperimentGroup revision ?
...
class ExperimentStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.lims.Experiment.ExperimentStore revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: experimentGroups:
           non-reciprocal link experimentGroups from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
one input sample in several experiments.
  """
  #   from data model element ccp.lims.Experiment.InputSample revision ?
...
Experiment.
  """
  #   from data model element ccp.lims.Experiment.OutputSample revision ?
...
class Parameter(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Experiment.Parameter revision ?
...
class ImportSample(Experiment):
  ...
  """
  #   from data model element ccp.lims.Experiment.ImportSample revision ?
