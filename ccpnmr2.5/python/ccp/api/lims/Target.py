...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:26:13 2015
  from data model element ccp.lims.Target revision ?
...
could groups targets that are not related by their properties.
  """
  #   from data model element ccp.lims.Target.Project revision ?
  _metaclass = metaPackage.getElement('Project')
  _packageName = 'ccp.lims.Target'
  _packageShortName = 'TARG'
  _fieldNames = ('applicationData', 'className', 'completeName', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'shortName', 'startDate', 'access', 'activeAccess', 'annotations', 'parent', 'project', 'root', 'subProjects', 'targetStore', 'targets', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: subProjects:
           non-reciprocal link subProjects from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: dbRefs:
           non-reciprocal link dbRefs from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: nucleicAcids:
           non-reciprocal link nucleicAcids from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      if (not (self in oldSelves)):
        raise ApiError("""%s.checkValid: protein:
         non-reciprocal link protein from object""" % self.qualifiedName
         + ": %s" % (self,)
        )
      ...
      if (value is not None):
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: species:
           non-reciprocal link species from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
protein family.
  """
  #   from data model element ccp.lims.Target.TargetGroup revision ?
  _metaclass = metaPackage.getElement('TargetGroup')
  _packageName = 'ccp.lims.Target'
  _packageShortName = 'TARG'
  _fieldNames = ('applicationData', 'className', 'completeName', 'details', 'fieldNames', 'groupingType', 'inConstructor', 'isDeleted', 'metaclass', 'namingSystem', 'packageName', 'packageShortName', 'qualifiedName', 'shortName', 'access', 'activeAccess', 'annotations', 'citations', 'entrys', 'parent', 'root', 'subTargetGroups', 'targetGroup', 'targetStore', 'targets', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: entrys:
           non-reciprocal link entrys from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: subTargetGroups:
           non-reciprocal link subTargetGroups from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class TargetStatus(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.lims.Target.TargetStatus revision ?
  _metaclass = metaPackage.getElement('TargetStatus')
  _packageName = 'ccp.lims.Target'
  _packageShortName = 'TARG'
  _fieldNames = ('applicationData', 'className', 'date', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'access', 'activeAccess', 'code', 'parent', 'root', 'target', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      if (not (self in oldSelves)):
        raise ApiError("""%s.checkValid: code:
         non-reciprocal link code from object""" % self.qualifiedName
         + ": %s" % (self,)
        )
...
class TargetStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.lims.Target.TargetStore revision ?
  _metaclass = metaPackage.getElement('TargetStore')
  _packageName = 'ccp.lims.Target'
  _packageShortName = 'TARG'
  _fieldNames = ('applicationData', 'className', 'createdBy', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'activeRepositories', 'memopsRoot', 'packageLocator', 'parent', 'projects', 'root', 'targetGroups', 'targets', 'topObject',)
