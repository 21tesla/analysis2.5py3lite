...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:39 2015
  from data model element ccp.molecule.ChemCompCharge revision ?
...
class ChemAtomCharge(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.ChemCompCharge.ChemAtomCharge revision ?
  _metaclass = metaPackage.getElement('ChemAtomCharge')
  _packageName = 'ccp.molecule.ChemCompCharge'
  _packageShortName = 'CCCA'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'partialCharge', 'qualifiedName', 'serial', 'subType', 'validVegaTypes', 'access', 'activeAccess', 'chemAtom', 'chemCompCharge', 'chemCompVarCharges', 'parent', 'root', 'topObject',)
...
class ChemCompCharge(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.molecule.ChemCompCharge.ChemCompCharge revision ?
  _metaclass = metaPackage.getElement('ChemCompCharge')
  _packageName = 'ccp.molecule.ChemCompCharge'
  _packageShortName = 'CCCA'
  _fieldNames = ('applicationData', 'ccpCode', 'className', 'createdBy', 'details', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'molType', 'packageName', 'packageShortName', 'qualifiedName', 'sourceName', 'access', 'activeAccess', 'activeRepositories', 'chemAtomCharges', 'chemComp', 'chemCompVarCharges', 'memopsRoot', 'packageLocator', 'parent', 'root', 'topObject',)
...
with an 'any' attribute must belong to all the relevant Vars
  """
  #   from data model element ccp.molecule.ChemCompCharge.ChemCompVarCharge revision ?
  _metaclass = metaPackage.getElement('ChemCompVarCharge')
  _packageName = 'ccp.molecule.ChemCompCharge'
  _packageShortName = 'CCCA'
  _fieldNames = ('applicationData', 'className', 'descriptor', 'fieldNames', 'inConstructor', 'isDeleted', 'linking', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'chemAtomCharges', 'chemCompCharge', 'chemCompVars', 'parent', 'root', 'topObject',)
