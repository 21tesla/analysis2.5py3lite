...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:26:15 2015
  from data model element ccp.molecule.MolStructure revision ?
...
a given set of coordinates.
  """
  #   from data model element ccp.molecule.MolStructure.Atom revision ?
  _metaclass = metaPackage.getElement('Atom')
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('altLocationCode', 'applicationData', 'bFactors', 'className', 'coordinates', 'elementSymbol', 'fieldNames', 'inConstructor', 'index', 'isDeleted', 'metaclass', 'name', 'occupancies', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'atom', 'atomValidations', 'chemAtom', 'coords', 'parent', 'residue', 'root', 'topObject',)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: coords:
           non-reciprocal link coords from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
  ...
  def newCoord(self, **attrlinks):
    """
    Factory function to generate Coord. Since Coords are no longer
    explicitly stored, serves to preserve legacy code, and effectively 
    functions as a setter.
    """
    dataDict = self.__dict__
    if (dataDict.get('isDeleted')):
      raise ApiError("""%s.newCoord:
       called on deleted object""" % self.qualifiedName
      )
  ...
  def setOccupancy(self, index, vaue):
    """
...
class Chain(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.MolStructure.Chain revision ?
...
class Coord(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.MolStructure.Coord revision ?
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      if (notIsReading):
        ...
        if (objKey is None):
          raise ApiError("""%s.__init__:
           Key attribute or link not set (from ['model'])""" % self.qualifiedName
           + ": %s" % (self,)
          )
        else:
          if (childrenDict.get(objKey) is None):
  ...
  def getAltLocationCode(self):
    """
    getter for derived attribute altLocationCode
    """
    dataDict = self.__dict__
    result = self.atom.altLocationCode
    return result
  ...
  def getBFactor(self):
    """
    getter for derived attribute bFactor
    """
    dataDict = self.__dict__
    dataMatrix = self.topObject.findFirstDataMatrix(name='bFactors')
    if dataMatrix:
      result = dataMatrix.getPointValue(point=(self.model.index,self.atom.index))
    else:
  ...
  def getFullKey(self, useGuid=False):
    ...
    result.append(obj4.__dict__.get('altLocationCode'))
  ...
  def getOccupancy(self):
    """
    getter for derived attribute occupancy
    """
    dataDict = self.__dict__
    dataMatrix = self.topObject.findFirstDataMatrix(name='occupancies')
    if dataMatrix:
  ...
  def getX(self):
    """
    getter for derived attribute x
    """
    dataDict = self.__dict__
    dataMatrix = self.topObject.findFirstDataMatrix(name='coordinates')
    if dataMatrix:
      result = dataMatrix.getPointValue(point=(self.model.index,self.atom.index,0))
    else:
  ...
  def getY(self):
    """
    getter for derived attribute y
    """
    dataDict = self.__dict__
    dataMatrix = self.topObject.findFirstDataMatrix(name='coordinates')
    if dataMatrix:
      result = dataMatrix.getPointValue(point=(self.model.index,self.atom.index,1))
    else:
      raise ApiError("%s lacks DataMatrix named 'coordinates''" % self.structureEnsemble)
    return result
  ...
  def getZ(self):
    """
    getter for derived attribute z
    """
    dataDict = self.__dict__
    dataMatrix = self.topObject.findFirstDataMatrix(name='coordinates')
    if dataMatrix:
      result = dataMatrix.getPointValue(point=(self.model.index,self.atom.index,2))
    else:
      raise ApiError("%s lacks DataMatrix named 'coordinates''" % self.structureEnsemble)
    return result
  ...
  def setAltLocationCode(self, value):
    """
    dummy setter for derived attribute altLocationCode. For backwards
    compatibility - will throw an error unless the altLocationCodeis 
    identical to the parent altLocationCode.
    """
    dataDict = self.__dict__
    if (isinstance(value, memops.api.Implementation.String.PythonType)):
      pass
    ...
    topObject = dataDict.get('topObject')
    currentValue = self.getAltLocationCode()
    notInConstructor = not (dataDict.get('inConstructor'))
  ...
  def setOccupancy(self, value):
    """
    setter for derived attribute occupancy
    """
    dataDict = self.__dict__
    if (isinstance(value, memops.api.Implementation.Float.PythonType)):
      pass
    ...
    topObject = dataDict.get('topObject')
    currentValue = self.getOccupancy()
    notInConstructor = not (dataDict.get('inConstructor'))
  ...
  def setX(self, value):
    """
    setter for derived attribute x
    """
    dataDict = self.__dict__
    if (isinstance(value, memops.api.Implementation.Float.PythonType)):
      pass
    ...
    dataMatrix = self.topObject.findFirstDataMatrix(name='coordinates')
    if dataMatrix:
      dataMatrix.setPointValue(point=(self.model.index,self.atom.index,0), value=value)
    else:
      raise ApiError("%s lacks DataMatrix named 'coordinates''" % self.structureEnsemble)
    if (notIsReading):
      if (notInConstructor):
  ...
  def setY(self, value):
    """
    setter for derived attribute y
    """
    dataDict = self.__dict__
    if (isinstance(value, memops.api.Implementation.Float.PythonType)):
      pass
    ...
    dataMatrix = self.topObject.findFirstDataMatrix(name='coordinates')
    if dataMatrix:
      dataMatrix.setPointValue(point=(self.model.index,self.atom.index,1), value=value)
    else:
      raise ApiError("%s lacks DataMatrix named 'coordinates''" % self.structureEnsemble)
    if (notIsReading):
      if (notInConstructor):
  ...
  altLocationCode = property(getAltLocationCode, setAltLocationCode, None,
  r"""Alternative location code for coordinate record. Derived -identical to 
  parent.altLocationCode. Settable only to simplify backwards 
  compatibility
  """)
...
###############################################################################
class DataMatrix(memops.api.Implementation.DataObject):
...
created
  """
  #   from data model element ccp.molecule.MolStructure.DataMatrix revision ?
  _metaclass = metaPackage.getElement('DataMatrix')
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('applicationData', 'className', 'data', 'defaultValue', 'details', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'ndim', 'packageName', 'packageShortName', 'qualifiedName', 'shape', 'size', 'unit', 'access', 'activeAccess', 'parent', 'root', 'structureEnsemble', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      try:
        ...
        print("ERROR in ccp.molecule.MolStructure.DataMatrix.__init__")
        del dataDict['inConstructor']
        raise
...
Corresponds to a PDB MODEL.
  """
  #   from data model element ccp.molecule.MolStructure.Model revision ?
  _metaclass = metaPackage.getElement('Model')
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('applicationData', 'bFactors', 'className', 'coordinates', 'details', 'fieldNames', 'inConstructor', 'index', 'isDeleted', 'metaclass', 'name', 'occupancies', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'access', 'activeAccess', 'coords', 'parent', 'root', 'structureEnsemble', 'structureGroups', 'structureValidations', 'topObject', 'violationLists',)
...
class Residue(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.MolStructure.Residue revision ?
...
trajectory for the MolSystem or part of it.
  """
  #   from data model element ccp.molecule.MolStructure.StructureEnsemble revision ?
  _metaclass = metaPackage.getElement('StructureEnsemble')
  _packageName = 'ccp.molecule.MolStructure'
  _packageShortName = 'COOR'
  _fieldNames = ('applicationData', 'atomNamingSystem', 'className', 'createdBy', 'details', 'ensembleId', 'fieldNames', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'nAtoms', 'packageName', 'packageShortName', 'qualifiedName', 'resNamingSystem', 'softwareName', 'access', 'activeAccess', 'activeRepositories', 'analysisLayouts', 'analysisPanels', 'coordChains', 'dataMatrices', 'ensembleValidations', 'memopsRoot', 'models', 'molSystem', 'orderedAtoms', 'packageLocator', 'parent', 'root', 'structureAnalyses', 'structureGeneration', 'topObject', 'validationStores',)
    ...
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    for analysisLayout in dataDict.get('analysisLayouts'):
      if (not (analysisLayout in objsToBeDeleted)):
        currentStructures = analysisLayout.__dict__.get('currentStructures')
        currentStructures.remove(self)

    for analysisPanel in dataDict.get('analysisPanels'):
      if (not (analysisPanel in objsToBeDeleted)):
        currentStructures = analysisPanel.__dict__.get('currentStructures')
        currentStructures.remove(self)
  ...
  def addAnalysisLayout(self, value):
    """
    Add for ccp.molecule.MolStructure.StructureEnsemble.analysisLayouts
    """
    dataDict = self.__dict__
    ...
    oldSelves = value.__dict__.get('currentStructures')
  ...
  def addAnalysisPanel(self, value):
    """
    Add for ccp.molecule.MolStructure.StructureEnsemble.analysisPanels
    """
    dataDict = self.__dict__
  ...
  def findAllAnalysisLayouts(self, **conditions):
    """
    FindAll for ccp.molecule.MolStructure.StructureEnsemble.analysisLayouts
    """
    dataDict = self.__dict__
    nConditions = len(conditions)
    if (nConditions == 0):
  ...
  def findAllAnalysisPanels(self, **conditions):
    """
    FindAll for ccp.molecule.MolStructure.StructureEnsemble.analysisPanels
    """
    dataDict = self.__dict__
    nConditions = len(conditions)
    if (nConditions == 0):
  ...
  def findFirstAnalysisLayout(self, **conditions):
    """
    FindFirst for
    ccp.molecule.MolStructure.StructureEnsemble.analysisLayouts
    """
    dataDict = self.__dict__
    nConditions = len(conditions)
    if (nConditions == 0):
  ...
  def findFirstAnalysisPanel(self, **conditions):
    """
    FindFirst for ccp.molecule.MolStructure.StructureEnsemble.analysisPanels
    """
    dataDict = self.__dict__
    nConditions = len(conditions)
    if (nConditions == 0):
  ...
  def getAnalysisLayouts(self):
    """
    Get for ccp.molecule.MolStructure.StructureEnsemble.analysisLayouts
    """
    dataDict = self.__dict__
    if (not ((dataDict.get('isLoaded') or dataDict.get('isReading')))):
      self.load()
  ...
  def getAnalysisPanels(self):
    """
    Get for ccp.molecule.MolStructure.StructureEnsemble.analysisPanels
    """
    dataDict = self.__dict__
    if (not ((dataDict.get('isLoaded') or dataDict.get('isReading')))):
      self.load()
  ...
  def removeAnalysisLayout(self, value):
    """
    Remove for ccp.molecule.MolStructure.StructureEnsemble.analysisLayouts
    """
    dataDict = self.__dict__
    from ccpnmr.api.AnalysisV3 import AnalysisLayout as importedType
    if (not isinstance(value, importedType)):
  ...
  def removeAnalysisPanel(self, value):
    """
    Remove for ccp.molecule.MolStructure.StructureEnsemble.analysisPanels
    """
    dataDict = self.__dict__
    from ccpnmr.api.AnalysisV3 import AnalysisPanel as importedType
    if (not isinstance(value, importedType)):
  ...
  def setAnalysisLayouts(self, values):
    """
    Set for ccp.molecule.MolStructure.StructureEnsemble.analysisLayouts
    """
    dataDict = self.__dict__
    xx = values
    values = set(values)
    ...
    for cv in currentValues:
      if (not (cv in values)):
        oldSelves = cv.__dict__.get('currentStructures')
        oldSelves.remove(self)
  ...
  def setAnalysisPanels(self, values):
    """
    Set for ccp.molecule.MolStructure.StructureEnsemble.analysisPanels
    """
    dataDict = self.__dict__
    xx = values
    values = set(values)
  ...
  def sortedAnalysisLayouts(self):
    """
    Sorted for ccp.molecule.MolStructure.StructureEnsemble.analysisLayouts
    """
    dataDict = self.__dict__
    if (not ((dataDict.get('isLoaded') or dataDict.get('isReading')))):
      self.load()
  ...
  def sortedAnalysisPanels(self):
    """
    Sorted for ccp.molecule.MolStructure.StructureEnsemble.analysisPanels
    """
    dataDict = self.__dict__
    if (not ((dataDict.get('isLoaded') or dataDict.get('isReading')))):
      self.load()
  ...
  r"""AnalysisLayouts referring StructureEnsembles
  """)
  
  analysisPanels = property(getAnalysisPanels, setAnalysisPanels, None,
  r"""AnalysisPanels referring StructureEnsembles
  """)
