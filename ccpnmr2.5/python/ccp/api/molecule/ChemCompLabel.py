...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:39 2015
  from data model element ccp.molecule.ChemCompLabel revision ?
...
class AtomLabel(memops.api.Implementation.DataObject):
  r"""Isotope labeling.
  """
  #   from data model element ccp.molecule.ChemCompLabel.AtomLabel revision ?
  _metaclass = metaPackage.getElement('AtomLabel')
  _packageName = 'ccp.molecule.ChemCompLabel'
  _packageShortName = 'CCLB'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'isotopeCode', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'subType', 'weight', 'access', 'activeAccess', 'chemAtom', 'isotope', 'isotopomer', 'parent', 'root', 'topObject',)
...
class ChemCompLabel(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.ChemCompLabel.ChemCompLabel revision ?
  _metaclass = metaPackage.getElement('ChemCompLabel')
  _packageName = 'ccp.molecule.ChemCompLabel'
  _packageShortName = 'CCLB'
  _fieldNames = ('applicationData', 'ccpCode', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'molType', 'packageName', 'packageShortName', 'qualifiedName', 'access', 'activeAccess', 'chemComp', 'isotopomers', 'labelingScheme', 'parent', 'root', 'topObject',)
...
uncorrelated isotope distribution on its atoms.
  """
  #   from data model element ccp.molecule.ChemCompLabel.Isotopomer revision ?
  _metaclass = metaPackage.getElement('Isotopomer')
  _packageName = 'ccp.molecule.ChemCompLabel'
  _packageShortName = 'CCLB'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'weight', 'access', 'activeAccess', 'atomLabels', 'chemCompLabel', 'parent', 'root', 'topObject',)
