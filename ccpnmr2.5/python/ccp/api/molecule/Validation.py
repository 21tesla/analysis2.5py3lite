...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:26:05 2015
...
class ValidationResult(ccp.api.general.Template.MultiTypeValue):
  r"""
  """
  #   from data model element ccp.molecule.Validation.ValidationResult revision ?
...
class ValidationStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.molecule.Validation.ValidationStore revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        oldSelf = value.getValidationStore()
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: nmrCalcStores:
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: validationResults:
           non-reciprocal link validationResults from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
  ...
  def getNmrCalcStores(self):
    """
    getter for derived link nmrCalcStores
    """
    dataDict = self.__dict__
    result = frozenset(self.memopsRoot.findAllNmrCalcStores(validationStoreName = self.name))
    return result
...
class NmrConstraintListValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.NmrConstraintListValidation revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: nmrConstraintLists:
           non-reciprocal link nmrConstraintLists from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class NmrConstraintValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.NmrConstraintValidation revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: nmrConstraints:
           non-reciprocal link nmrConstraints from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class NmrMeasurementListValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.NmrMeasurementListValidation revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: nmrMeasurementLists:
           non-reciprocal link nmrMeasurementLists from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class NmrMeasurementValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.NmrMeasurementValidation revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: nmrMeasurements:
           non-reciprocal link nmrMeasurements from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class PeakValidation(ValidationResult):
  r"""
  """
  #   from data model element ccp.molecule.Validation.PeakValidation revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: peaks:
           non-reciprocal link peaks from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class PeakListValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.PeakListValidation revision ?
...
class ResidueValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.ResidueValidation revision ?
...
class AtomValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.AtomValidation revision ?
...
class StructureValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.StructureValidation revision ?
...
class EntryValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.EntryValidation revision ?
...
class ChainValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.ChainValidation revision ?
...
class MolSysAtomValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.MolSysAtomValidation revision ?
...
class MolSystemValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.MolSystemValidation revision ?
...
class MolSysChainValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.MolSysChainValidation revision ?
...
class MolSysResidueValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.MolSysResidueValidation revision ?
...
class EnsembleValidation(ValidationResult):
  ...
  """
  #   from data model element ccp.molecule.Validation.EnsembleValidation revision ?
