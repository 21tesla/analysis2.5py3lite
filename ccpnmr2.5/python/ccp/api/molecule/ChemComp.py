...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:31 2015
    ...
    if value is not None and value not in validDescriptors:
      ...
      for desc in value.split(';'):
        ...
        try:
          ...
          print("Malformed descriptor %s: %s does not contain ':'" % (value, str(desc)))
          isValid = False
          break
        ...
        if ii is None:
          # tag validity
          print("Malformed descriptor %s: %s is not a valid tag" % (value, str(tag)))
          isValid = False
          break
          
        elif ii < tagIndex:
          # tag order
          print("Malformed descriptor %s: tag %s appears out of sequence" % (value, str(tag)))
          isValid = False
          break
          ...
          if subNo <= lastSubNo:
            ...
            print("Malformed descriptor %s: %s is out of order" % (value, str(desc)))
            isValid = False
            break
