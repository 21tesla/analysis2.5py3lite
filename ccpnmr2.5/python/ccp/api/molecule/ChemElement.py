...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:24 2015
...
class ChemElement(memops.api.Implementation.DataObject):
  r"""e.g. C
  """
  #   from data model element ccp.molecule.ChemElement.ChemElement revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: isotopes:
           non-reciprocal link isotopes from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class ChemElementStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.molecule.ChemElement.ChemElementStore revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: chemElements:
           non-reciprocal link chemElements from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class Isotope(memops.api.Implementation.DataObject):
  r"""Nuclear Isotope
  """
  #   from data model element ccp.molecule.ChemElement.Isotope revision ?
