...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:55 2015
  from data model element ccp.molecule.LabeledMolecule revision ?
...
class AtomLabel(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.LabeledMolecule.AtomLabel revision ?
...
class LabeledMixture(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.LabeledMolecule.LabeledMixture revision ?
  _metaclass = metaPackage.getElement('LabeledMixture')
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('applicationData', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'metaclass', 'name', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'access', 'activeAccess', 'averageComposition', 'experiments', 'labeledMolecule', 'molComponents', 'molLabelFractions', 'parent', 'root', 'topObject',)
  ...
  r"""User intelligible name of LabeledMixture
  """)
...
class MolLabel(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.LabeledMolecule.MolLabel revision ?
...
LabeledMixture (association class).
  """
  #   from data model element ccp.molecule.LabeledMolecule.MolLabelFraction revision ?
...
ResLabelFractions.
  """
  #   from data model element ccp.molecule.LabeledMolecule.ResLabel revision ?
...
class ResLabelFraction(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.molecule.LabeledMolecule.ResLabelFraction revision ?
...
residue, except those attached to any SingleAtomLabel object.
  """
  #   from data model element ccp.molecule.LabeledMolecule.UniformAtomLabel revision ?
...
and ResLabelFraction records present for the same residue ID(s)
  """
  #   from data model element ccp.molecule.LabeledMolecule.SingleAtomLabel revision ?
  _metaclass = metaPackage.getElement('SingleAtomLabel')
  _packageName = 'ccp.molecule.LabeledMolecule'
  _packageShortName = 'LMOL'
  _fieldNames = ('applicationData', 'atomName', 'className', 'fieldNames', 'inConstructor', 'isDeleted', 'massNumber', 'metaclass', 'packageName', 'packageShortName', 'qualifiedName', 'serial', 'weight', 'access', 'activeAccess', 'chemAtom', 'parent', 'resLabel', 'root', 'topObject',)
