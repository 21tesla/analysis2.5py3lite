...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:26:47 2015
...
other depositions?).
  """
  #   from data model element ccp.nmr.NmrEntry.Entry revision ?
...
class EntryMolecule(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.nmr.NmrEntry.EntryMolecule revision ?
...
class NmrEntryStore(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccp.nmr.NmrEntry.NmrEntryStore revision ?
...
class RelatedEntry(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.nmr.NmrEntry.RelatedEntry revision ?
...
class Study(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.nmr.NmrEntry.Study revision ?
