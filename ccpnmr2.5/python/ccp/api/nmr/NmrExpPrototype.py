...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:30 2015
  from data model element ccp.nmr.NmrExpPrototype revision ?
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: expGraphs:
           non-reciprocal link expGraphs from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: expMeasurements:
           non-reciprocal link expMeasurements from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
molecule topologies giving rise to peaks of different sign.
  """
  #   from data model element ccp.nmr.NmrExpPrototype.ExpGraph revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (self in oldSelves)):
          raise ApiError("""%s.checkValid: atomSites:
           non-reciprocal link atomSites from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: expSteps:
           non-reciprocal link expSteps from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
others are possible.
  """
  #   from data model element ccp.nmr.NmrExpPrototype.ExpMeasurement revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: refExpDimRefs:
           non-reciprocal link refExpDimRefs from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
times, e.g. for out-and-back experiments.
  """
  #   from data model element ccp.nmr.NmrExpPrototype.ExpStep revision ?
...
observable peaks from a ginve ExpGraph.
  """
  #   from data model element ccp.nmr.NmrExpPrototype.ExpTransfer revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      if (value is not None):
        if (not (value in ['onebond', 'Jcoupling', 'Jmultibond', 'relayed', 'through-space', 'relayed-alternate'])):
          raise ApiError("""%s.checkValid: transferType:
           ccp.nmr.NmrExpPrototype.ExpTransferType input is not in enumeration ['onebond', 'Jcoupling', 'Jmultibond', 'relayed', 'through-space', 'relayed-alternate']""" % self.qualifiedName
           + ": %s" % (value,)
          )
...
experiment
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      value = dataDict.get('priority')
      if (isinstance(value, memops.api.Implementation.Int.PythonType)):
        pass
      elif ([x for x in memops.api.Implementation.Int.compatibleTypes if isinstance(value, x)]):
        value = memops.api.Implementation.Int.create(value)
      else:
        raise ApiError("""%s.checkValid: priority:
         memops.Implementation.PositiveInt input is not of a valid type""" % self.qualifiedName
         + ": %s" % (value,)
        )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: refExperiments:
           non-reciprocal link refExperiments from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
  ...
  def getPriority(self):
    """
    Get for ccp.nmr.NmrExpPrototype.NmrExpPrototype.priority
    """
    dataDict = self.__dict__
    result = dataDict.get('priority')
    return result
  ...
  def setPriority(self, value):
    """
    Set for ccp.nmr.NmrExpPrototype.NmrExpPrototype.priority
    """
    dataDict = self.__dict__
    if (isinstance(value, memops.api.Implementation.Int.PythonType)):
      pass
    ...
    currentValue = dataDict.get('priority')
    notInConstructor = not (dataDict.get('inConstructor'))
  ...
  priority = property(getPriority, setPriority, None,
  r"""Experiment priority. Serves to classify experiments for display so that 
  the more common can be more prominently displayed. Intended use would be 
...
class RefExpDim(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.nmr.NmrExpPrototype.RefExpDim revision ?
...
available in the NmrExpPrototype
  """
  #   from data model element ccp.nmr.NmrExpPrototype.RefExperiment revision ?
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: refExpDims:
           non-reciprocal link refExpDims from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: systematicNames:
           non-reciprocal link systematicNames from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
...
class SystematicName(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccp.nmr.NmrExpPrototype.SystematicName revision ?
