...
amxPseudo = {"HB*": (1.0, {"H": 0.6}), "HG*": (1.0, {"H": 1.0, "HA": 0.6}), "HD*": (1.0, {"HA": 1.0}), "HE*": (1.0, {})}
...
linkTorsions = {
    ("protein",): [
        ("OMEGA", ["prev_2", "prev_1", "N", "CA"]),
        ("PHI", ["prev_1", "N", "CA", "C"]),
        ("PSI", ["N", "CA", "C", "next_1"]),
    ],
    ("DNA", "RNA"): [
        ("ZETA", ["prev_2", "prev_1", "P", "O5'"]),
...
linkBonds = {
    ("protein",): [("singleplanar", "unknown", ["prev_1", "N"]), ("singleplanar", "unknown", ["C", "next_1"])],
    ("DNA", "RNA"): [("single", None, ["prev_1", "P"]), ("single", None, ["O3'", "next_1"])],
}

linkEndDict = {
    ("protein",): {"prev": ["N", "CA"], "next": ["C", "CA"]},  # These are 'backwards'
    ("DNA", "RNA"): {"prev": ["P", "O5'"], "next": ["O3'", "C3'"]},  # These are 'backwards'
}

linkingEnds = {"middle": ["prev", "next"], "start": ["next"], "end": ["prev"]}
