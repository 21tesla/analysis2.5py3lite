...
# =========================================================================================
__copyright__ = (
    "Copyright (C) CCPN project (www.ccpn.ac.uk) 2014 - $Date: 2014-10-10 15:24:16 +0100 (Fri, 10 Oct 2014) $"
)
...
def _mapPartAssignedResonances(nmrProject, assignmentMap, molSystem, chainMap=None):
    ...
    for resonanceGroup in nmrProject.sortedResonanceGroups():
        ...
        if residue:
            ...
            chemComp = nmrProject.root.findFirstChemComp(molType=resonanceGroup.molType, ccpCode=resonanceGroup.ccpCode)
            if chemComp:
