...
from ccp.format.general.formatIO import Citation, Keyword, Person
                ...
                if self.infoType == "contactPersons":
                    ...
                    if tableName in self.saveFrame.tables:
                        ...
                        for i in range(0, len(tableTags["ID"])):
                            ...
                            self.personInGroups.append(
                                PersonInGroup(self, serial=tableTags["ID"][i], *personInGroupInfo)
                            )
            ...
            #
                ...
                if citationType == "journal":
                    ...
                    citationTagNames += [
                        ...
                        "Page_first",
                        "Year",
                        "Thesis_institution_city",
                        "Thesis_institution",
                        "Thesis_institution_country",
                        "isPrimary",
                        "Page_last",
                        None,
                        "PubMed_ID",
