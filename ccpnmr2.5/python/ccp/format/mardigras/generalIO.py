...
generalIO.py: General I/O information for Mardigras files
...
class MardigrasGenericFile(FormatFile):
    def setGeneric(self):
...
class MardigrasConstraintItem:
    def __init__(self):

        self.members = []


class MardigrasConstraintMember:
    def __init__(self):
