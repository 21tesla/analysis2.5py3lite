...
from ccp.format.general.Constants import bioPolymerCodes, defaultSeqInsertCode
                ...
                if coordinate.chainId == coordChain.chainId:
                    ...
                    if seqCode != coordinate.seqCode or seqInsertCode != coordinate.insertionCode:
                        self.sequences[-1].elements.append(
                            AmberSequenceElement(
                                str(coordinate.seqCode) + coordinate.insertionCode, coordinate.resName, self
                            )
                        )
