...
from ccp.format.pales.generalIO import PalesConstraintItem, PalesConstraintMember, PalesGenericFile
...
class PalesRdcConstraint:
    ...
    def setAtomMembers(self, chainCode, seqCode1, resLabel1, atomName1, seqCode2, resLabel2, atomName2):
        ...
        self.items[-1].members.append(
            PalesConstraintMember(chainCode, returnInt(seqCode1), string.upper(resLabel1), string.upper(atomName1))
        )
        self.items[-1].members.append(
            PalesConstraintMember(chainCode, returnInt(seqCode2), string.upper(resLabel2), string.upper(atomName2))
        )
