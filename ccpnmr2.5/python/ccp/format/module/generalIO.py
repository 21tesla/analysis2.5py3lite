...
generalIO.py: General I/O information for Module files (see http://www.ibs.fr/ext/labos/LRMN/softs/module/)
...
class ModuleGenericFile(FormatFile):
    def setGeneric(self):
...
class ModuleConstraintItem:
    def __init__(self):

        self.members = []


class ModuleConstraintMember:
