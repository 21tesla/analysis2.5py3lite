        ...
        self.readDict = {
            ...
            "BOND": {
                ...
                3: (
                    "bondType",
                    string.strip,
                ),  # 1 = single, 2 = double, 3 = triple, am = amide, ar = aromatic, du = dummy, un = unknown, nc = not connected
    ...
    def readGeneric(self, verbose=0):
        ...
        while line:
            ...
            if triposTagSearch:
                ...
                sectionLine = 0
                if triposSection not in self.infoDict:
        ...
        for i in range(totalAtoms):
            ...
            if atomInfo["atomId"] == rootAtomId and atomInfo["substName"] == substName:
                ...
                while atomInfo["substName"] == substName:
                    ...
                    if atomType not in atomNamesByElement:
                        atomNamesByElement[atomType] = {}
                    if atomName not in atomNamesByElement[atomType]:
