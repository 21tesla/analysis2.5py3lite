...
from ccp.format.concoord.generalIO import (
    ConcoordConstraintItem,
    ConcoordConstraintMember,
    ConcoordGenericFile,
    returnSegId,
)
...
class ConcoordDistanceConstraint:
    ...
    def setDistances(self, values, columnNames):
        ...
        for i in range(0, len(columnNames)):
            ...
            if columnName in self.distRefDict:
                value = values[i]
    ...
    def addItem(self, values, columnNames):
        ...
        for i in range(1, 1 + self.parent.constraintElements):
            ...
            for j in range(0, len(columnNames)):
                ...
                if columnName[-1] == str(i) and columnName[:-1] in self.itemRefDict:
                    value = values[j]
