...
# Class definitions #
#####################
from ccp.format.nmrView.peaksIO import NmrViewPeak, NmrViewPeakFile
from ccp.format.nmrView.sequenceIO import NmrViewSequence, NmrViewSequenceElement, NmrViewSequenceFile
                    ...
                    #
                        ...
                        if tagtable.tagnames.count("_Peaklist_label") > 0:
                            ...
                            for i in range(0, len(tagtable.tagvalues[0])):
                                ...
                                peakFile.peaks.append(
                                    NmrViewPeak(peaknum, assign, ppm, width, box, shape, volume, intensity, status)
                                )
                    ...
                    #
                        ...
                        if tagtable.tagnames.count("_Residue_seq_code") > 0:
                            for i in range(0, len(tagtable.tagvalues[0])):
                                ...
                                self.sequenceFile.sequences[-1].elements.append(
                                    NmrViewSequenceElement(seqCode, code3Letter)
                                )
...
if __name__ == "__main__":
    files = [
        "../../reference/nmrView/Brucd44_new2.str",
