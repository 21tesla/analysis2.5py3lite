...
from memops.universal.Io import getTopDirectory, splitPath
    ...
    def read(self, verbose=0):
            ...
            if len(cols) == 0 or self.patt["hash"].search(line):
                ...
                while line:
                    ...
                    if len(cols) != defColsLen:
                        print(
                            "  Warning: ignoring following line in %s peak file (columns don't match):\n%s"
                            % (self.format, line)
                        )
                        pass
        ...
        for aInd in range(0, self.numDim):
            ...
            for ppmInd in range(0, self.numDim):
                ...
                if mappingIndex in self.mapping and self.mapping[mappingIndex] > prefPpmInd[1]:
        ...
        for aInd in range(0, self.numDim):
            if assign[aInd]:
                ...
                for ppmInd in range(0, self.numDim):
                    ...
                    if mappingIndex not in self.mapping:
...
if __name__ == "__main__":
    files = [
        "../../reference/ccpNmr/michaelNewYork/050309/fhsqc_stapp.PCK",
