...
generalIO.py: General I/O information for Cosmos files
...
class CosmosGenericFile(FormatFile):
    def setGeneric(self):
...
class CosmosConstraintItem:
    def __init__(self):

        self.members = []


class CosmosConstraintMember:
    def __init__(self, chainCode, seqCode, atomName, residueName):
