...
from memops.universal.Geometry import matrixMultiply, matrixRotX, matrixRotY
...
from memops.universal.Util import buttonClick, buttonMotion, buttonRelease, isWindowsOS
...
class ViewStructureFrame(ScrolledCanvas):
    ...
    def printStructure(self):
        ...
        try:
            printHandler = PrintHandler.PrintHandler(outputHandler, xRegion=(x0, x1), yRegion=(y0, y1))
