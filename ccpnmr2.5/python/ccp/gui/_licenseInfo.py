...
licenseInfo = (
    {
        "includeFiles": ["NmrExpPrototypeEditor.py"],
        "includeFileMatches": [],
        "format": None,
        "author": "Rasmus Fogh",
    ...
    {
        "includeFiles": ["ViewChemCompVarFrame.py", "ViewStructureFrame.py"],
        "includeFileMatches": [],
        "format": None,
        "author": "Tim Stevens",
        "organization": "University of Cambridge",
    ...
    {
        "includeFiles": ["ViewRamachandranFrame.py"],
        "includeFileMatches": [],
        "format": None,
        "author": "Tim Stevens, Nicole Cheung",
        "organization": "University of Cambridge",
        "useLicense": "LGPL",
        "programFunction": None,
        "programType": None,
    ...
    },
    {
        ...
        "format": None,
        "author": "Wayne Boucher, Rasmus Fogh, Tim Stevens and Wim Vranken",
