...
from ccp.util.NmrCalc import deleteRunParameter, getRunTextParameter, setRunParameter
from ccpnmr.analysis.popups.EditCalculation import RESIDUE_DATA, STRUCTURE_DATA, NmrCalcRunFrame
