...
Wms.py: python API for CCPN data model, MetaPackage cambridge.Wms
...
metaPackage = memops.api.Implementation.topPackage.metaObjFromQualName('cambridge.Wms')

###############################################################################
class Project(memops.api.Implementation.DataObject):
  r"""Wms project
  """
  #   from data model element cambridge.Wms.Project revision ?
  ...
  def __init__(self, parent, **attrlinks):
    ...
    dataDict['wmsSegment'] = parent
    if (not isinstance(parent, WmsSegment)):
    ...
    try:
      ...
      dataDict['name'] = None
      dataDict['nmrCalcRunSerial'] = None
      dataDict['nmrCalcStoreName'] = None
      dataDict['access'] = None
      dataDict['projectVersions'] = {}
      dataDict['rawFiles'] = {}
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    """
    checkDelete for cambridge.Wms.Project:
    ...
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    if (wmsSegment not in objsToBeDeleted):
      ...
      if (objKey is None):
        ...
        dd = wmsSegment.__dict__.get('projects')
  ...
  def checkAllValid(self, complete=False):
    ...
    values = dataDict.get('projectVersions').values()
    for value in values:
      value.checkAllValid(complete)

    values = dataDict.get('rawFiles').values()
    for value in values:
      value.checkAllValid(complete)

  def checkValid(self, complete=False):
    """
    CheckValid for cambridge.Wms.Project
    """
    dataDict = self.__dict__
    ...
    if (complete):
      ...
      value = dataDict.get('nmrCalcRunSerial')
      if (value is not None):
        if (isinstance(value, memops.api.Implementation.Int.PythonType)):
          ...
          raise ApiError("""%s.checkValid: nmrCalcRunSerial:
      ...
      value = dataDict.get('nmrCalcStoreName')
      if (value is not None):
        if (isinstance(value, memops.api.Implementation.String.PythonType)):
          pass
        else:
          raise ApiError("""%s.checkValid: nmrCalcStoreName:
           memops.Implementation.Line input is not of a valid type""" % self.qualifiedName
           + ": %s" % (value,)
          )
      ...
      values = dataDict.get('rawFiles').values()
      for value in values:
        if (not isinstance(value, RawFile)):
          raise ApiError("""%s.checkValid: rawFiles:
           value is not of class cambridge.Wms.RawFile""" % self.qualifiedName
           + ": %s" % (value,)
          )
      ...
      value = dataDict.get('wmsSegment')
      if (not isinstance(value, WmsSegment)):
        raise ApiError("""%s.checkValid: wmsSegment:
         value is not of class cambridge.Wms.WmsSegment""" % self.qualifiedName
         + ": %s" % (value,)
        )
  ...
  def findFirstProjectVersion(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      objKey = conditions.get('versionTag')
      if (objKey is not None):
        result = dataDict.get('projectVersions').get(objKey)
  ...
  def findFirstRawFile(self, **conditions):
    ...
    if (nConditions == 0):
      ...
      if (objKey is not None):
        result = dataDict.get('rawFiles').get(objKey)
  ...
  def getByKey(startObj, fullKey):
    ...
    if (startObj.__class__.__name__ == 'MemopsRoot'):
      if (2 != len(fullKey)):
        raise ApiError("""'cambridge.Wms.Project'.getByKey:
      ...
      obj0 = startObj
      objKey = fullKey[0]
      obj1 = obj0.__dict__.get('wmsSegments').get(objKey)
      if (obj1 is None):
        obj0.refreshTopObjects('cambridge.Wms')
        obj1 = obj0.__dict__.get('wmsSegments').get(objKey)
  ...
  def getProjectVersions(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = dataDict.get('projectVersions').values()
  ...
  def getRawFiles(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = dataDict.get('rawFiles').values()
    result = frozenset(tempVar)
    return result
  ...
  def setLocation(self, value):
    """
    Set for cambridge.Wms.Project.location
    """
    dataDict = self.__dict__
    from memops.api.Implementation import Url as importedType
    if (not isinstance(value, importedType)):
  ...
  def setName(self, value):
    """
    Set for cambridge.Wms.Project.name
    """
    dataDict = self.__dict__
    if (isinstance(value, memops.api.Implementation.String.PythonType)):
      pass
  ...
  def setNmrCalcInfo(self, value):
    ...
    if (value is not None):
      from ccp.api.nmr.NmrCalc import Run as importedType
      if (not isinstance(value, importedType)):
        raise ApiError("""%s.setNmrCalcInfo:
         value is not of class ccp.nmr.NmrCalc.Run""" % self.qualifiedName
         + ": %s" % (value,)
        )

    topObject = dataDict.get('topObject')
    currentValue = self.getNmrCalcInfo()
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    if value is None:
      self.nmrCalcRunSerial = None
      self.nmrCalcStoreName = None
    else:
      self.nmrCalcRunSerial = value.serial
      self.nmrCalcStoreName = value.nmrCalcStore.name
    if (notIsReading):
      if (notInConstructor):
        topObject.__dict__['isModified'] = True

  def setNmrCalcRunSerial(self, value):
    """
    Set for cambridge.Wms.Project.nmrCalcRunSerial
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.Int.PythonType)):
        ...
        raise ApiError("""%s.setNmrCalcRunSerial:
         memops.Implementation.PositiveInt input is not of a valid type""" % self.qualifiedName
         + ": %s" % (value,)
        )
    ...
    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('nmrCalcRunSerial')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    dataDict['nmrCalcRunSerial'] = value
    if (notIsReading):
      if (notInConstructor):
        topObject.__dict__['isModified'] = True
  ...
  def setNmrCalcStoreName(self, value):
    """
    Set for cambridge.Wms.Project.nmrCalcStoreName
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
        ...
        raise ApiError("""%s.setNmrCalcStoreName:
         memops.Implementation.Line input is not of a valid type""" % self.qualifiedName
         + ": %s" % (value,)
        )
    ...
    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('nmrCalcStoreName')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    dataDict['nmrCalcStoreName'] = value
    if (notIsReading):
      if (notInConstructor):
        topObject.__dict__['isModified'] = True
  ...
  def sortedProjectVersions(self):
    """
    Sorted for cambridge.Wms.Project.projectVersions
    """
    dataDict = self.__dict__
...
###############################################################################
class ProjectVersion(memops.api.Implementation.DataObject):
  r"""Version (timestamped snapshot) of the Project
  """
  #   from data model element cambridge.Wms.ProjectVersion revision ?
  _metaclass = metaPackage.getElement('ProjectVersion')
  _packageName = 'cambridge.Wms'
  _packageShortName = 'WMS'
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      dataDict['applicationData'] = list()
      dataDict['creationTime'] = None
      dataDict['status'] = None
      dataDict['summary'] = None
      dataDict['versionTag'] = None
      dataDict['access'] = None
      dataDict['createdByTask'] = None
      dataDict['outputTasks'] = set()
      ...
      if (notIsReading):
        childrenDict = parent.__dict__.get('projectVersions')
        objKey = dataDict.get('versionTag')
        if (objKey is None):
          raise ApiError("""%s.__init__:
           Key attribute or link not set (from ['versionTag'])""" % self.qualifiedName
           + ": %s" % (self,)
          )
        else:
          if (childrenDict.get(objKey) is None):
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    """
    checkDelete for cambridge.Wms.ProjectVersion:
    ...
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    if (project not in objsToBeDeleted):
      ...
      if (objKey is None):
        ...
        dd = project.__dict__.get('projectVersions')
        if (self is dd.get(objKey)):
          del dd[objKey]
  ...
  def addOutputTask(self, value):
    ...
    if (oldSelf is not None):
      siblingValues = oldSelf.__dict__.get('outputTasks')
      siblingValues.remove(value)

    value.__dict__['inputVersion'] = self
  ...
  def checkAllValid(self, complete=False):
    """
    CheckAllValid for cambridge.Wms.ProjectVersion
    """
    dataDict = self.__dict__
    self.checkValid(complete)
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      value = dataDict.get('creationTime')
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
        pass
      else:
        raise ApiError("""%s.checkValid: creationTime:
      ...
      value = dataDict.get('summary')
      if (value is not None):
        if (isinstance(value, memops.api.Implementation.String.PythonType)):
          pass
        else:
          raise ApiError("""%s.checkValid: summary:
           memops.Implementation.Line input is not of a valid type""" % self.qualifiedName
           + ": %s" % (value,)
          )
      ...
      value = dataDict.get('createdByTask')
      if (value is not None):
        if (not isinstance(value, Task)):
      ...
      values = dataDict.get('outputTasks')
      for value in values:
        if (not isinstance(value, Task)):
  ...
  def getByKey(startObj, fullKey):
    ...
    if (startObj.__class__.__name__ == 'MemopsRoot'):
      if (3 != len(fullKey)):
        raise ApiError("""'cambridge.Wms.ProjectVersion'.getByKey:
         getByKey called with fullKey of wrong length. Parameters:"""
         + ": %s:%s" % (startObj, fullKey)
        )
    ...
    if (obj1 is not None):
      ...
      if (obj2 is not None):
        objKey = fullKey[-1]
        obj3 = obj2.__dict__.get('projectVersions').get(objKey)
        result = obj3
  ...
  def getCreationTime(self):
    ...
    """
    dataDict = self.__dict__
    result = dataDict.get('creationTime')
    return result
  ...
  def getFullKey(self, useGuid=False):
    ...
    obj2 = dataDict.get('project')
    obj1 = obj2.__dict__.get('wmsSegment')
    ...
    result.append(dataDict.get('versionTag'))
  ...
  def getOutputTasks(self):
    ...
    """
    dataDict = self.__dict__
    tempVar = dataDict.get('outputTasks')
    result = frozenset(tempVar)
    return result
  ...
  def removeOutputTask(self, value):
    ...
    value.__dict__['inputVersion'] = None
  ...
  def set(self, name, value):
    """
    SetAttr for cambridge.Wms.ProjectVersion
    """
    dataDict = self.__dict__
    setattr(self, name, value)
  ...
  def setCreatedByTask(self, value):
    ...
    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('createdByTask')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    if (currentValue is not None):
      currentValue.__dict__['generatedVersion'] = None

    if (value is not None):
      oldSelf = value.__dict__.get('generatedVersion')
      if (oldSelf is not None):
        oldSelf.__dict__['createdByTask'] = None

      value.__dict__['generatedVersion'] = self

    dataDict['createdByTask'] = value
    if (notIsReading):
      if (notInConstructor):
        topObject.__dict__['isModified'] = True
  ...
  def setCreationTime(self, value):
    """
    Set for cambridge.Wms.ProjectVersion.creationTime
    """
    dataDict = self.__dict__
    if (isinstance(value, memops.api.Implementation.String.PythonType)):
      pass
    else:
      raise ApiError("""%s.setCreationTime:
       memops.Implementation.DateTime input is not of a valid type""" % self.qualifiedName
       + ": %s" % (value,)
      )

    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('creationTime')
    notInConstructor = not (dataDict.get('inConstructor'))
  ...
  def setOutputTasks(self, values):
    """
    Set for cambridge.Wms.ProjectVersion.outputTasks
    """
    dataDict = self.__dict__
    xx = values
    values = set(values)
    ...
    for cv in values:
      ...
      cv.__dict__['inputVersion'] = self

    dataDict['outputTasks'] = values
    if (notIsReading):
      if (notInConstructor):
        topObject.__dict__['isModified'] = True
  ...
  def setStatus(self, value):
    """
    Set for cambridge.Wms.ProjectVersion.status
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
  ...
  def setSummary(self, value):
    """
    Set for cambridge.Wms.ProjectVersion.summary
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
    ...
    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('summary')
    notInConstructor = not (dataDict.get('inConstructor'))
  ...
  def setVersionTag(self, value):
    """
    Set for cambridge.Wms.ProjectVersion.versionTag
    """
    dataDict = self.__dict__
    if (isinstance(value, memops.api.Implementation.String.PythonType)):
      pass
...
###############################################################################
class RawFile(memops.api.Implementation.DataObject):
  r"""Raw data file asociated with Wms Segment
  """
  #   from data model element cambridge.Wms.RawFile revision ?
  _metaclass = metaPackage.getElement('RawFile')
  _packageName = 'cambridge.Wms'
  _packageShortName = 'WMS'
      ...
      if (notOverride):
        if (dataDict.get('serial') is None):
          ...
          raise ApiError("""%s.__init__:
           ...
           + ": %s:%s" % (parent, 'cambridge.Wms.RawFile')
          )

      if (notIsReading):
        childrenDict = parent.__dict__.get('rawFiles')
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    """
    checkDelete for cambridge.Wms.RawFile:
       determines cascading deletes 
    to follow from delete of object.
       *Implementation function* - should 
    be called only by API delete function.
    ...
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    if (project not in objsToBeDeleted):
      ...
      if (objKey is None):
        ...
        dd = project.__dict__.get('rawFiles')
        if (self is dd.get(objKey)):
          del dd[objKey]
  ...
  def getByKey(startObj, fullKey):
    ...
    if (startObj.__class__.__name__ == 'MemopsRoot'):
      if (3 != len(fullKey)):
        raise ApiError("""'cambridge.Wms.RawFile'.getByKey:
         getByKey called with fullKey of wrong length. Parameters:"""
         + ": %s:%s" % (startObj, fullKey)
        )
    ...
    if (obj1 is not None):
      ...
      if (obj2 is not None):
        objKey = fullKey[-1]
        obj3 = obj2.__dict__.get('rawFiles').get(objKey)
        result = obj3
  ...
  def setLocation(self, value):
    """
    Set for cambridge.Wms.RawFile.location
    """
    dataDict = self.__dict__
    from memops.api.Implementation import Url as importedType
    if (not isinstance(value, importedType)):
  ...
  def setPath(self, value):
    """
    Set for cambridge.Wms.RawFile.path
    """
    dataDict = self.__dict__
    if (isinstance(value, memops.api.Implementation.String.PythonType)):
      pass
  ...
  def setSerial(self, value):
    """
    Set for cambridge.Wms.RawFile.serial
    """
    dataDict = self.__dict__
    if (isinstance(value, memops.api.Implementation.Int.PythonType)):
      pass
    ...
    parent = dataDict.get('project')
    oldSerial = parent.__dict__.get('_serialDict').get('rawFiles')
    if (value < 0):
      value = (oldSerial + 1)
      parent.__dict__.get('_serialDict')['rawFiles'] = value
...
###############################################################################
class Task(memops.api.Implementation.DataObject):
  r"""Abstract task - describing the kind of operation that can be done on 
data.
  """
  #   from data model element cambridge.Wms.Task revision ?
  _metaclass = metaPackage.getElement('Task')
  _packageName = 'cambridge.Wms'
  _packageShortName = 'WMS'
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      dataDict['applicationData'] = list()
      dataDict['dateCompleted'] = None
      dataDict['dateStarted'] = None
      dataDict['nmrCalcRunSerial'] = None
      dataDict['nmrCalcStoreName'] = None
      dataDict['operatorId'] = None
      dataDict['protocolName'] = None
      dataDict['serial'] = None
      dataDict['status'] = None
      dataDict['summary'] = None
      dataDict['access'] = None
      dataDict['generatedVersion'] = None
      dataDict['inputVersion'] = None
      ...
      if (notOverride):
        if (dataDict.get('serial') is None):
          ...
          raise ApiError("""%s.__init__:
           Cannot pass in explicit serial if not reading""" % self.qualifiedName
           + ": %s:%s" % (parent, 'cambridge.Wms.Task')
          )

      if (notIsReading):
        childrenDict = parent.__dict__.get('tasks')
        objKey = dataDict.get('serial')
        if (objKey is None):
          raise ApiError("""%s.__init__:
           Key attribute or link not set (from ['serial'])""" % self.qualifiedName
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    """
    checkDelete for cambridge.Wms.Task:
    ...
    *Implementation 
    ...
    if (wmsSegment not in objsToBeDeleted):
      ...
      if (objKey is None):
        ...
        dd = wmsSegment.__dict__.get('tasks')
        if (self is dd.get(objKey)):
          del dd[objKey]
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      value = dataDict.get('dateCompleted')
      if (value is not None):
        if (isinstance(value, memops.api.Implementation.String.PythonType)):
          pass
        else:
          raise ApiError("""%s.checkValid: dateCompleted:
           memops.Implementation.DateTime input is not of a valid type""" % self.qualifiedName
           + ": %s" % (value,)
          )

      value = dataDict.get('dateStarted')
      if (value is not None):
        if (isinstance(value, memops.api.Implementation.String.PythonType)):
          pass
        else:
          raise ApiError("""%s.checkValid: dateStarted:
           memops.Implementation.DateTime input is not of a valid type""" % self.qualifiedName
           + ": %s" % (value,)
          )
      ...
      value = dataDict.get('operatorId')
      if (value is not None):
        if (isinstance(value, memops.api.Implementation.String.PythonType)):
          pass
        else:
          raise ApiError("""%s.checkValid: operatorId:
           memops.Implementation.Word input is not of a valid type""" % self.qualifiedName
           + ": %s" % (value,)
          )
      ...
      value = dataDict.get('protocolName')
      if (value is not None):
        if (isinstance(value, memops.api.Implementation.String.PythonType)):
          pass
        else:
          raise ApiError("""%s.checkValid: protocolName:
           memops.Implementation.Word input is not of a valid type""" % self.qualifiedName
           + ": %s" % (value,)
          )
      ...
      value = dataDict.get('generatedVersion')
      if (value is not None):
        if (not isinstance(value, ProjectVersion)):
      ...
      value = dataDict.get('inputVersion')
      if (value is not None):
        if (not isinstance(value, ProjectVersion)):
  ...
  def getByKey(startObj, fullKey):
    ...
    if (startObj.__class__.__name__ == 'MemopsRoot'):
      if (2 != len(fullKey)):
        raise ApiError("""'cambridge.Wms.Task'.getByKey:
         getByKey called with fullKey of wrong length. Parameters:"""
         + ": %s:%s" % (startObj, fullKey)
        )
    ...
    if (obj1 is not None):
      ...
      objKey = fullKey[-1]
      obj2 = obj1.__dict__.get('tasks').get(objKey)
      result = obj2
  ...
  def getDateStarted(self):
    ...
    """
    dataDict = self.__dict__
    result = dataDict.get('dateStarted')
    return result
  ...
  def getGeneratedVersion(self):
    ...
    """
    dataDict = self.__dict__
    result = dataDict.get('generatedVersion')
    return result
  ...
  def getInputVersion(self):
    ...
    """
    dataDict = self.__dict__
    result = dataDict.get('inputVersion')
    return result
  ...
  def getOperatorId(self):
    ...
    """
    dataDict = self.__dict__
    result = dataDict.get('operatorId')
    return result
  ...
  def getProtocolName(self):
    ...
    """
    dataDict = self.__dict__
    result = dataDict.get('protocolName')
    return result
  ...
  def setDateCompleted(self, value):
    ...
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
        ...
        raise ApiError("""%s.setDateCompleted:
         memops.Implementation.DateTime input is not of a valid type""" % self.qualifiedName
         + ": %s" % (value,)
        )

    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('dateCompleted')
    notInConstructor = not (dataDict.get('inConstructor'))
  ...
  def setDateStarted(self, value):
    """
    Set for cambridge.Wms.Task.dateStarted
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
        ...
        raise ApiError("""%s.setDateStarted:
         memops.Implementation.DateTime input is not of a valid type""" % self.qualifiedName
         + ": %s" % (value,)
        )

    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('dateStarted')
    notInConstructor = not (dataDict.get('inConstructor'))
  ...
  def setGeneratedVersion(self, value):
    """
    Set for cambridge.Wms.Task.generatedVersion
    """
    dataDict = self.__dict__
    if (value is not None):
      if (not isinstance(value, ProjectVersion)):
    ...
    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('generatedVersion')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    if (currentValue is not None):
      currentValue.__dict__['createdByTask'] = None

    if (value is not None):
      oldSelf = value.__dict__.get('createdByTask')
      if (oldSelf is not None):
        oldSelf.__dict__['generatedVersion'] = None

      value.__dict__['createdByTask'] = self

    dataDict['generatedVersion'] = value
    if (notIsReading):
      if (notInConstructor):
        topObject.__dict__['isModified'] = True
  ...
  def setInputVersion(self, value):
    """
    Set for cambridge.Wms.Task.inputVersion
    """
    dataDict = self.__dict__
    if (value is not None):
      if (not isinstance(value, ProjectVersion)):
    ...
    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('inputVersion')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    if (currentValue is not None):
      if (notIsReading):
        oldSelves = currentValue.__dict__.get('outputTasks')
        oldSelves.remove(self)
      else:
        raise ApiError("""%s.setInputVersion:
         Read link 'inputVersion' incompatible with pre-existing link""" % self.qualifiedName
         + ": %s" % (self,)
        )

    if (value is not None):
      newSelves = value.__dict__.get('outputTasks')
      newSelves.add(self)

    dataDict['inputVersion'] = value
    if (notIsReading):
      if (notInConstructor):
        topObject.__dict__['isModified'] = True
  ...
  def setNmrCalcRun(self, value):
    """
    setter for derived link nmrCalcRun
    """
    dataDict = self.__dict__
    if (value is not None):
      from ccp.api.nmr.NmrCalc import Run as importedType
      if (not isinstance(value, importedType)):
        raise ApiError("""%s.setNmrCalcRun:
         value is not of class ccp.nmr.NmrCalc.Run""" % self.qualifiedName
         + ": %s" % (value,)
        )

    topObject = dataDict.get('topObject')
    currentValue = self.getNmrCalcRun()
    notInConstructor = not (dataDict.get('inConstructor'))
  ...
  def setNmrCalcRunSerial(self, value):
    """
    Set for cambridge.Wms.Task.nmrCalcRunSerial
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.Int.PythonType)):
  ...
  def setNmrCalcStoreName(self, value):
    """
    Set for cambridge.Wms.Task.nmrCalcStoreName
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
  ...
  def setOperatorId(self, value):
    """
    Set for cambridge.Wms.Task.operatorId
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
        ...
        raise ApiError("""%s.setOperatorId:
         memops.Implementation.Word input is not of a valid type""" % self.qualifiedName
         + ": %s" % (value,)
        )
    ...
    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('operatorId')
    notInConstructor = not (dataDict.get('inConstructor'))
  ...
  def setProtocolName(self, value):
    """
    Set for cambridge.Wms.Task.protocolName
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
        ...
        raise ApiError("""%s.setProtocolName:
         memops.Implementation.Word input is not of a valid type""" % self.qualifiedName
         + ": %s" % (value,)
        )
    ...
    topObject = dataDict.get('topObject')
    currentValue = dataDict.get('protocolName')
    notInConstructor = not (dataDict.get('inConstructor'))
  ...
  def setSerial(self, value):
    """
    Set for cambridge.Wms.Task.serial
    """
    dataDict = self.__dict__
    if (isinstance(value, memops.api.Implementation.Int.PythonType)):
      pass
    ...
    parent = dataDict.get('wmsSegment')
    oldSerial = parent.__dict__.get('_serialDict').get('tasks')
    if (value < 0):
      value = (oldSerial + 1)
      parent.__dict__.get('_serialDict')['tasks'] = value
    elif (value > oldSerial):
      parent.__dict__.get('_serialDict')['tasks'] = value
  ...
  def setSummary(self, value):
    """
    Set for cambridge.Wms.Task.summary
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
...
###############################################################################
class WmsSegment(memops.api.Implementation.TopObject):
  r"""Compartment of workflow management system
  """
  #   from data model element cambridge.Wms.WmsSegment revision ?
  _metaclass = metaPackage.getElement('WmsSegment')
  _packageName = 'cambridge.Wms'
  _packageShortName = 'WMS'
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      if (not (dataDict.get('isReading'))):
        parent.refreshTopObjects('cambridge.Wms')
      ...
      if (notIsReading):
        childrenDict = parent.__dict__.get('wmsSegments')
        objKey = dataDict.get('name')
        if (objKey is None):
          raise ApiError("""%s.__init__:
           Key attribute or link not set (from ['name'])""" % self.qualifiedName
  ...
  def _checkDelete(self, objsToBeDeleted, objsToBeChecked, linkCounter, topObjectsToCheck):
    """
    checkDelete for cambridge.Wms.WmsSegment:
       determines cascading 
    deletes to follow from delete of object.
       *Implementation function* - 
    should be called only by API delete function.
  ...
  def _singleDelete(self, objsToBeDeleted):
    ...
    *Implementation function* - will CORRUPT DATA if called outside 
    ...
    dataDict['isDeleted'] = True
    memopsRoot = dataDict.get('memopsRoot')
    if (self is memopsRoot.__dict__.get('currentWmsSegment')):
    ...
    if (memopsRoot not in objsToBeDeleted):
      ...
      if (objKey is None):
        ...
        dd = memopsRoot.__dict__.get('wmsSegments')
        if (self is dd.get(objKey)):
          del dd[objKey]
  ...
  def checkAllValid(self, complete=False):
    ...
    values = dataDict.get('tasks').values()
    for value in values:
      value.checkAllValid(complete)

  def checkValid(self, complete=False):
    """
    CheckValid for cambridge.Wms.WmsSegment
    """
    dataDict = self.__dict__
    if (dataDict.get('isDeleted')):
      raise ApiError("""%s.checkValid:
  ...
  def getByKey(startObj, fullKey):
    ...
    result = None
    if (1 != len(fullKey)):
      raise ApiError("""'cambridge.Wms.WmsSegment'.getByKey:
       getByKey called with fullKey of wrong length. Parameters:"""
       + ": %s:%s" % (startObj, fullKey)
      )

    objKey = fullKey[0]
    obj1 = startObj.__dict__.get('wmsSegments').get(objKey)
    if (obj1 is None):
      startObj.refreshTopObjects('cambridge.Wms')
      obj1 = startObj.__dict__.get('wmsSegments').get(objKey)
