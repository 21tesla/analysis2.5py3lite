...
from ccpnmr.analysis.core.AssignmentBasic import assignAtomsToRes, getAtomSetShifts, getShiftLists
...
from memops.gui.MessageReporter import showError, showInfo, showOkCancel, showWarning, showYesNo
