...
from memops.general import Application, Implementation


class BasePopup(memops.gui.BasePopup.BasePopup):
    def __init__(self, parent, project=None, popup_name=None, turnNotifiersOnOff=True, application=None, *args, **kw):
        ...
        if "class_" not in kw and project and hasattr(project, "application") and project.application:
