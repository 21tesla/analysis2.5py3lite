...
def convertStringToFileName(fileNameString):
    ...
    from memops.general.Constants import defaultFileNameChar, validCcpnFileNameChars

    return doConvertStringToFileName(fileNameString, validCcpnFileNameChars, defaultFileNameChar)
