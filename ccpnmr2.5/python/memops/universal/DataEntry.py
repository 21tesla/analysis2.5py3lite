...
def askInteger(title, prompt, initial_value="", min_value=None, max_value=None, *args, **kw):

    return askData("integer", prompt, initial_value, min_value, max_value)


def askFloat(title, prompt, initial_value="", min_value=None, max_value=None, *args, **kw):
