...
def getOutputHandler(
    ...
    unit_width=1.0,
    unit_height=1.0,
    scaling_choice=Output.scaling_choices[0],
    output_scaling=0.8,
    w_scaling=1.0,
    h_scaling=1.0,
    paper_size=None,
    ...
    if output_format in PostScript.format_choices:
        outputHandler = PostScript.PostScript(
            file_name=file_name,
            plot_size=plot_size,
        ...
        if PsHandler:
            ...
            #                 output_style)
            cHandler = PsHandler.PsHandler(file_name, plot_size[0], plot_size[1], output_style)
        else:
            cHandler = None

    elif output_format in Pdf.format_choices:
        outputHandler = Pdf.Pdf(
            file_name=file_name,
            plot_size=plot_size,
            plot_units=plot_units,
            paper_size=paper_size,
        ...
        if PdfHandler:
            ...
            #                 output_style)
            cHandler = PdfHandler.PdfHandler(file_name, plot_size[0], plot_size[1], output_style)
        else:
            cHandler = None
