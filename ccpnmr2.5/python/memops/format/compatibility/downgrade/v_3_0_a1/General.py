...
def extraMapChanges(globalMapping):
    ...
    globalMapping["loadMaps"]["IMPL.KeyWord"] = globalMapping["loadMaps"]["IMPL.Word"]
    globalMapping["IMPL"]["abstractTypes"]["KeyWord"] = globalMapping["IMPL"]["abstractTypes"]["Word"]
    keyWordTypeGuid = "www.ccpn.ac.uk_Fogh_2014-03-07-15:48:27_00001"
    wordTypeGuid = "www.ccpn.ac.uk_Fogh_2006-08-16-14:22:53_00037"
    globalMapping["mapsByGuid"][keyWordTypeGuid] = globalMapping["mapsByGuid"][wordTypeGuid]

    # undelay typechanged attributes.
    # NB these are manually checked, and are either 1) String/Text changes or FLoat/Double changes (handled by I/O code)
    from memops.format.compatibility.downgrade.v_3_0_a1.MapInfo import typeChanges

    getGuidMap = globalMapping["mapsByGuid"].get
