...
skipElements = [
    (
        "IMPL",
        "MemopsRoot",
        "currentNmrScreenStore",
        "ccpn_automatic_memops.Implementation.MemopsRoot.currentNmrScreenStore",
        "MetaRole",
    ),
...
delayElements = [
    (
        ...
        "WindowPanelGroup",
        "showSameSpectra",
        "www.ccpn.ac.uk_Fogh_2011-11-30-11:04:35_00004",
        {"tag": "ANAY.WindowPanelGroup.showSameSpectra", "type": "attr", "name": "showSameSpectra"},
        "www.ccpn.ac.uk_Fogh_2006-08-16-14:22:53_00028",
    ),
    (
        "CALC",
        "NmrCalcStore",
        "methodStoreName",
        "www.ccpn.ac.uk_Fogh_2010-05-10-13:46:58_00003",
        {"eType": "cplx", "tag": "CALC.NmrCalcStore.methodStoreName", "type": "attr", "name": "methodStoreName"},
        "www.ccpn.ac.uk_Fogh_2006-08-16-14:22:53_00033",
    ),
    (
        "CALC",
        "NmrCalcStore",
        "softwareName",
        "www.ccpn.ac.uk_Fogh_2010-05-10-13:46:58_00004",
        {"eType": "cplx", "tag": "CALC.NmrCalcStore.softwareName", "type": "attr", "name": "softwareName"},
        "www.ccpn.ac.uk_Fogh_2006-08-16-14:22:53_00033",
    ),
    (
        "CALC",
        "NmrCalcStore",
        "softwareVersion",
        "www.ccpn.ac.uk_Fogh_2010-05-10-13:46:58_00005",
        {"eType": "cplx", "tag": "CALC.NmrCalcStore.softwareVersion", "type": "attr", "name": "softwareVersion"},
        "www.ccpn.ac.uk_Fogh_2006-08-16-14:22:53_00033",
    ),
    (
        "NMRS",
        "Mixture",
        "pH",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00019",
        {"tag": "NMRS.Mixture.pH", "type": "attr", "name": "pH"},
        "www.ccpn.ac.uk_Fogh_2006-08-16-14:22:53_00031",
    ),
    (
        "NMRS",
        "Mixture",
        "solvent",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00020",
        {"eType": "cplx", "tag": "NMRS.Mixture.solvent", "type": "attr", "name": "solvent"},
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:32_00005",
    ),
    (
        "NMRS",
        "Mixture",
        "volume",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00018",
        {"tag": "NMRS.Mixture.volume", "type": "attr", "name": "volume"},
        "www.ccpn.ac.uk_Fogh_2006-08-16-14:22:54_00007",
    ),
    (
        "NMRS",
        "MixtureComponent",
        "concentration",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00025",
        {"tag": "NMRS.MixtureComponent.concentration", "type": "attr", "name": "concentration"},
        "www.ccpn.ac.uk_Fogh_2006-08-16-14:22:54_00007",
    ),
]
...
newConstraints = [
    (
        "cambridge.WmsProtocol.InterfaceParameter.hicard.hicard_consistent_with_ProtocolParameter_hicard",
        "www.ccpn.ac.uk_Fogh_2013-10-11-09:59:51_00001",
    ),
    (
        "cambridge.WmsProtocol.InterfaceParameter.locard.locard_consistent_with_ProtocolParameter_locard",
        "www.ccpn.ac.uk_Fogh_2013-10-11-09:59:51_00002",
    ),
    ("ccp.nmr.NmrCalc.Run.masterRun.derived_runs_cannot_be_nested", "www.ccpn.ac.uk_Fogh_2012-06-04-14:36:41_00003"),
    (
        "ccp.nmr.NmrReference.ChemAtomNmrDistrib.consistent_number_valuesPerPoint",
        "www.ccpn.ac.uk_Fogh_2012-04-13-14:02:18_00001",
    ),
    (
        "ccp.nmr.NmrReference.ChemAtomNmrDistrib.nd_distribution_is_normalised",
        "www.ccpn.ac.uk_Fogh_2012-04-13-14:02:18_00002",
    ),
    ("ccp.nmr.NmrReference.ChemAtomNmrDistrib.numbers_are_positive", "www.ccpn.ac.uk_Fogh_2012-04-13-14:02:18_00003"),
    (
        "ccp.nmr.NmrReference.ChemAtomNmrDistrib.refAtoms.len_refatoms_eq_ndim",
        "www.ccpn.ac.uk_Fogh_2012-04-13-13:40:44_00005",
    ),
...
renames = [
    ...
    (
        ...
        "www.ccpn.ac.uk_Fogh_2011-11-30-11:03:44_00013",
    ),
...
allDiffs = [
    (
        "cambridge.WmsProtocol.InterfaceParameter.hicard",
        "hicard",
        "www.ccpn.ac.uk_Fogh_2011-03-22-17:23:24_00005",
        "www.ccpn.ac.uk_Fogh_2011-03-22-17:23:24_00005",
        set(["defaultValue", "documentation", "locard"]),
    ),
    (
        "cambridge.WmsProtocol.InterfaceParameter.locard",
        "locard",
        "www.ccpn.ac.uk_Fogh_2011-03-22-17:23:24_00006",
        "www.ccpn.ac.uk_Fogh_2011-03-22-17:23:24_00006",
        set(["defaultValue", "documentation"]),
    ),
    (
        "ccp.lims.Holder.Holder.holderCategories",
        "holderCategories",
        "www.ccpn.ac.uk_Fogh_2006-08-16-18:23:27_00006",
        "www.ccpn.ac.uk_Fogh_2006-08-16-18:23:27_00006",
        set(["locard"]),
    ),
    (
        "ccp.lims.Sample.AbstractSample.sampleCategories",
        "sampleCategories",
        "www.ccpn.ac.uk_Fogh_2006-08-16-18:22:46_00003",
        "www.ccpn.ac.uk_Fogh_2006-08-16-18:22:46_00003",
        set(["locard"]),
    ),
    (
        "ccp.nmr.NmrReference.ChemAtomNmrDistrib.refAtoms",
        "refAtoms",
        "www.ccpn.ac.uk_Fogh_2010-05-14-17:17:46_00001",
        "www.ccpn.ac.uk_Fogh_2010-05-14-17:17:46_00001",
        set(["changeability"]),
    ),
    (
        "ccp.nmr.NmrScreen.NmrScreen",
        "NmrScreen",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:32_00006",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:32_00006",
        set(["supertype", "parentRole", "partitionsChildren", "supertypes"]),
    ),
    (
        "ccp.nmr.NmrScreen.NmrScreen.startDate",
        "startDate",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00038",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00038",
        set(["locard"]),
    ),
    (
        "ccp.nmr.NmrScreen.RefSpectrum.concentration",
        "concentration",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00053",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00053",
        set(["container"]),
    ),
    (
        "ccp.nmr.NmrScreen.RefSpectrum.dataSource",
        "dataSource",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00050",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00050",
        set(["container"]),
    ),
    (
        "ccp.nmr.NmrScreen.RefSpectrum.details",
        "details",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00056",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00056",
        set(["container"]),
    ),
    (
        "ccp.nmr.NmrScreen.RefSpectrum.name",
        "name",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00052",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00052",
        set(["container"]),
    ),
    (
        "ccp.nmr.NmrScreen.RefSpectrum.pH",
        "pH",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00054",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00054",
        set(["container"]),
    ),
    (
        "ccp.nmr.NmrScreen.RefSpectrum.serial",
        "serial",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00051",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00051",
        set(["container"]),
    ),
    (
        "ccp.nmr.NmrScreen.RefSpectrum.solvent",
        "solvent",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00055",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00055",
        set(["container"]),
    ),
    (
        "ccp.nmr.NmrScreen.Solvent",
        "Solvent",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:32_00005",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:32_00005",
    ...
    (
        "ccp.nmr.NmrScreen.Trial",
        "Trial",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:32_00009",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:32_00009",
        set(["parentRole"]),
    ),
    (
        "ccp.nmr.NmrScreen.Trial.mixture",
        "mixtures",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00014",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:38_00014",
        set(["hicard", "name", "locard"]),
    ),
    (
        "ccp.nmr.NmrScreen.TrialExperiment",
        "TrialExperiment",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:32_00012",
        "www.ccpn.ac.uk_Fogh_2009-11-19-14:50:32_00012",
        set(["parentRole"]),
    ),
    (
        "ccpnmr.Analysis.PeakDrawMethod",
        "PeakDrawMethod",
        "www.ccpn.ac.uk_Fogh_2006-10-03-11:26:03_00002",
        "www.ccpn.ac.uk_Fogh_2006-10-03-11:26:03_00002",
        set(["enumeration"]),
    ),
    (
        "ccpnmr.Analysis.PeakFindVolumeMethod",
        "PeakFindVolumeMethod",
        "www.ccpn.ac.uk_Fogh_2006-10-03-11:26:03_00003",
        "www.ccpn.ac.uk_Fogh_2006-10-03-11:26:03_00003",
        set(["enumeration"]),
    ),
    (
        "ccpnmr.Analysis.SymbolStyle",
        "SymbolStyle",
        "www.ccpn.ac.uk_Fogh_2008-05-05-18:37:53_00002",
        "www.ccpn.ac.uk_Fogh_2008-05-05-18:37:53_00002",
        set(["enumeration"]),
    ),
]
