...
def doMajorUpgradeToCurrent(oldPath, oldTag, oldName=None, newName=None, newDir=None, doSave=True):
    ...
    try:
        ...
        oldRoot, oldVersionStr, oldTags = getOldData(oldPath, oldTag, curVersion, oldName=oldName)
        ...
        result = majorUpgradeToCurrent(
            oldRoot, oldVersionStr, newName=newName, newDir=newDir, doSave=doSave, oldTags=oldTags
        )
    finally:
        gc.enable()
