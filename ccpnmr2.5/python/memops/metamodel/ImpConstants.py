...
visibility_enumeration = (public_visibility, protected_visibility, private_visibility)
...
direction_enumeration = (in_direction, out_direction, inout_direction, return_direction)
