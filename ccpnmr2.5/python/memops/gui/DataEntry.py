...
def askString(title, prompt, initial_value="", parent=None):
    ...
    return QueryDialogBox.askString(title, prompt, initialvalue=initial_value, parent=parent)


def askInteger(title, prompt, initial_value="", min_value=None, max_value=None, parent=None):

    return QueryDialogBox.askInteger(
        title, prompt, initialvalue=initial_value, minvalue=min_value, maxvalue=max_value, parent=parent
    )


def askFloat(title, prompt, initial_value="", min_value=None, max_value=None, parent=None):

    return QueryDialogBox.askFloat(
        title, prompt, initialvalue=initial_value, minvalue=min_value, maxvalue=max_value, parent=parent
    )


def askFile(title, prompt, initial_value="", parent=None, dismiss_text="Cancel", extra_dismiss_text=""):
...
def askDir(
    title, prompt, initial_value="", parent=None, dismiss_text="Cancel", extra_dismiss_text="", default_dir=None
):
...
class DataEntry:
    ...
    def askInteger(self, title, prompt, initial_value="", min_value=None, max_value=None, parent=None, *args, **kw):

        return askInteger(title, prompt, initial_value, min_value, max_value, parent)

    def askFloat(self, title, prompt, initial_value="", min_value=None, max_value=None, parent=None, *args, **kw):

        return askFloat(title, prompt, initial_value, min_value, max_value, parent)

    def askFile(
        self, title, prompt, initial_value="", parent=None, dismiss_text="Cancel", extra_dismiss_text="", *args, **kw
    ):
