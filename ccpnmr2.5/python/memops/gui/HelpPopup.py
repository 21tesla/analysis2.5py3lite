...
class HelpFrame(Frame):
    ...
    def showUrl(self, url, offset=None, forceLoad=False, allowModifyPath=True, popup=None):
...
def createHelpPopup(parent):
    ...
    if not hasattr(parent, "help_popup") or not parent.help_popup:
        kw = {"transient": True}
        help_popup = BasePopup.createPopup(parent, frameClass=HelpFrame, title="Help Module", popup_kw=kw)
        help_popup.close()
