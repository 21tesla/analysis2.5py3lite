    ...
    def __init__(self, parent, *args, **kw):
        ...
        for n in range(3):
            ...
            self.labeled_scale[n] = LabeledScale(
                frame, values=range(101), label_format="%3d", set_callback=self.scaleCallback
            )
    ...
    def setupColorBox(self):
        ...
        for x in range(np):
            ...
            for y in range(np):
                ...
                p = self.colorBox.create_rectangle(
                    2 + pw * x, 2 + pw * y, 2 + (pw * x) + pw, (2 + pw * y) + pw, outline=c, fill=c
                )
