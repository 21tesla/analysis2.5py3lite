    ...
    def __init__(
        ...
        **kw,
        ...
        for n, entry in enumerate(entries):
            ...
            b = CheckButton(
                self, text=str(entry), callback=callback, docKey=docKeys[n], tipText=tipTexts[n], selected=selected[n]
            )
...
if __name__ == "__main__":
    ...
    c = CheckButtons(root, ["one", "two", "three"], select_callback=my_callback, tipTexts=["Tip A", "Tip B", "Tip C"])
    c.grid()
