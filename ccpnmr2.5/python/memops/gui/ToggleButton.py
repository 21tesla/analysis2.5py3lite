...
class ToggleButton(Button):
    def __init__(
        self, parent, toggledDict, untoggledDict, command=None, toggled=False, docKey=None, tipText=None, *args, **kw
    ):

        Button.__init__(self, parent, docKey=docKey, tipText=tipText, *args, **kw)
...
if __name__ == "__main__":
    ...
    button = ToggleButton(root, text="hit me", tipText="Comment", toggledDict=toggledDict, untoggledDict=untoggledDict)
    button.grid()
