...
RadioButton.py: <write function here>
...
class RadioButton(Tkinter.Radiobutton, Base):
    def __init__(self, parent, text="", callback=None, docKey=None, tipText=None, *args, **kw):

        if not docKey:
            docKey = text

        Tkinter.Radiobutton.__init__(self, parent, text=text, *args, **kw)
