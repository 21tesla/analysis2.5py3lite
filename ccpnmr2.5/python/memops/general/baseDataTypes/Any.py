...
Float.py: Basic data type implementation for CCPN Python data model API
...
# conversion from string - NB will not work in all cases.
# Type 'Any' is not serialisable
fromString = eval
