...
baseDataTypeModule = __import__("memops.general.baseDataTypes", globals(), locals(), typeCode_enumeration)
...
javaSimpleTypeCode_enumeration = ["int", "long", "float", "double", "boolean", None]
javaSimpleTypeCode_enumeration.sort(key=lambda x: (x is None, x if x is not None else ""))

# names of xml data types.
xmlTypeCode_enumeration = ["string", "boolean", "int", "long", "float", "double", "Dict", "List"]
