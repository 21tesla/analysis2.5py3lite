...
references.py: license header generation code for CCPN framework

Copyright (C) 2004-2005  (CCPN Project)
...
references = {
    "MIDGE1991": """M. Madrid, E. Llinas and M. Llinas (1991).
...
Journal Of Magnetic Resonance 93: 329-346.""",
    "CLOUDS2002": """A. Grishaev and M. Llinas (2002).
CLOUDS, a protocol for deriving a molecular proton density via NMR.
Proc Natl Acad Sci USA. 99, 6707-6712.""",
    "CCPN2002": """R. Fogh, J. Ionides, E. Ulrich, W. Boucher, W. Vranken, J.P. Linge, M.
Habeck, W. Rieping, T.N. Bhat, J. Westbrook, K. Henrick, G. Gilliland,
H. Berman, J. Thornton, M. Nilges, J. Markley and E. Laue (2002). The
CCPN project: An interim report on a data model for the NMR community
(Progress report). Nature Struct. Biol. 9, 416-418.""",
    "MSD2004": """A. Pajon, J. Ionides, J. Diprose, J. Fillon, R. Fogh, A.W. Ashton,
