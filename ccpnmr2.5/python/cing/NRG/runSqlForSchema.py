...
$C/python/cing/NRG/runSqlForSchema.py nmr_redo  $C/python/cing/NRG/sql/setup_Schema.sql  .          
$C/python/cing/NRG/runSqlForSchema.py nmr_redo  $C/python/cing/NRG/sql/createDB-CING_psql.sql  .          
"""
