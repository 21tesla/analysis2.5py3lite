...
#        log( "cgi: %s\n" % str(self.cgi) )
        ...
        if 'query_type' in self.cgi and self.cgi['query_type'].value == "normal":
            print("Content-Type: text/plain\n")
...
#        print 'DEBUG: now in processSimpleTextBoxQuery'
        ...
        # end def
        pdb_id = ''
        if 'id' in self.cgi: # the id might not even exist if the submitted value was empty.
