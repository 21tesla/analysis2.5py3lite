...
from pdbe.chemComp.Constants import (
  ...
  editChemCompDataDir,
  editLinkedChemCompCoordDataDir,
  editLinkedChemCompDataDir,
  obsoleteChemCompCoordDataDir,
  obsoleteChemCompDataDir,
  tempChemCompDir,
  testChemCompCoordDataDir,
  testChemCompDataDir,
)
from pdbe.chemComp.Util import getGuidFromXmlFileName, removeFreshTag, tagAsFresh
