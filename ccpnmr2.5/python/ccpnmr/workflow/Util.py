...
from memops.general.Io import loadProject, packageProject, saveProject
...
class WorkFlow:
    ...
    def reportUnlinkedResonances(self, resonanceList):
        ...
        if unlinkedRes:
            ...
            print()
            print(
                "Warning: %d (out of %d) resonances not linked in %s." % (unlinkedRes, len(resonanceList), parentText)
            )
            print()
