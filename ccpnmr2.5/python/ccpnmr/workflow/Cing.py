...
from pdbe.adatah.Io import getDataFromHttp, posturl
...
class WebCing(CingWorkFlow):
    ...
    def cingRequest(self, action, uploadFileName=None):
        ...
        returnPage = posturl(
            self.cingService, [("UserId", self.userId), ("AccessKey", self.accessKey), ("Action", action)], uploadList
        )
