...
if __name__ == "__main__":
  ...
  """
    ...
    jsonObject = intUtil.wmsProjectSummary(memopsRoot, nmrProjectName=nmrProjectName)

    # If jsonFile is relative this puts it relative to project repository
    # If it is absoolute it goes where it should
    jsonFile = os.path.join(memopsRoot.findFirstActiveRepository().url.dataLocation, jsonFile)
    fp = open(jsonFile, "w")
