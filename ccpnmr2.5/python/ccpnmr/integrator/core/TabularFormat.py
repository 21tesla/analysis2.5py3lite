...
class TabularFormat:
    ...
    def addData(self, keyword, value, extraKeywords=None, comment=None, multipleValue=False):
        """Add data line"""
    ...
    def addSequence(self, sequence):
        ...
        """
        raise NotImplementedError("addSequence not implemented in format %s" % self.format)
    ...
    def addTableLine(self, values):
        ...
        if len(values) != self.numTableColumns:
            raise ValueError("%s values passed to %s-column table" % (len(values), self.numTableColumns))
