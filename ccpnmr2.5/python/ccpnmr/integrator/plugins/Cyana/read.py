...
def read(nmrCalcRun, dataDir):
    ...
    nmrCalcRun.newRunParameter(name="summary", ioRole="output", textValue=summary)

    # Get MolSystem
    molResidueData = nmrCalcRun.findFirstData(className="MolResidueData", ioRole="input") or nmrCalcRun.findFirstData(
        className="MolSystemData", ioRole="input"
    )
    ...
    nmrCalcRun.newStructureEnsembleData(
        name="result", ioRole="output", structureEnsemble=ensemble, details="Cyana calculated structures"
    )
