    ...
    **Caveats & Tips**
    ...
    def __init__(
        ...
        if exitOnClose:
            ...
            quitFunc = lambda k=0: self.destroy()
            os._exit(0)
        else:
            quitFunc = None
    ...
    def body(self, guiParent):
        ...
        tipTexts = [
            "The name of the file for which an update is available",
        ...
        tipTexts = [
            "Refresh the list of file updates by querying the CCPN update server, assuming an Internet connection is present",
