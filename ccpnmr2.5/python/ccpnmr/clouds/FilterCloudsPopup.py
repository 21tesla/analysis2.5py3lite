...
from ccpnmr.clouds.CloudBasic import getCloudsFromFile, getFileNamesFromPattern, writeTypedPdbCloud
from ccpnmr.clouds.FilterClouds import (
    alignClouds,
    alignCoordinates,
    alignToMeanCloud,
    centerCoords,
...
class FilterCloudsPopup(BasePopup):
    ...
    def body(self, guiFrame):
        ...
        self.fileNameEntry = Entry(guiFrame, text=r"testHistone\d+.pdb", returnCallback=self.loadClouds)
        ...
        self.strucPulldown = PulldownMenu(
            guiFrame, entries=self.getStructures(), callback=self.setStructure, selected_index=0, do_initial_callback=0
        )
        ...
        self.atomsPulldown = PulldownMenu(
            guiFrame, entries=atomTypes, callback=self.setAtomTypes, selected_index=0, do_initial_callback=0
        )
        ...
        self.bottomButtons = createDismissHelpButtonList(
            guiFrame, texts=texts, expands=1, commands=commands, help_url=self.help_url
        )
