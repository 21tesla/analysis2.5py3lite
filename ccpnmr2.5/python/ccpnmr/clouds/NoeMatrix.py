...
def getNoeMatrixFromPeaks(
    noePeaks, resonances, noesyPeakLists, mixingTimes, ratioHD=0.9, intensityType="height", analysis=None
):
    ...
    if len(spectrum.dataDims) == 2:
        ...
        noePeaks = filterPeaks(
            noePeaks, diagonalThreshold=0.04, removeUnassigned=1, minimumVolume=None, excludeRegions=None
        )
