...
def generateClouds(numClouds, constraints, resonances, coolingScheme, filePrefix):
    ...
    (dynamicsEngine, noeForceField) = makeDynamicsProtocol(
        noe_force_const=25,
        noe_exponent=2,
        noe_soft_exponent=1,
        noe_r_switch=0.5,
    ...
    for i in range(numClouds):
        ...
        newAtomCoords = runDynamicsProtocol(atomCoordList, noeConstrList, dynamicsEngine, noeForceField, coolingScheme)
...
def runDynamicsProtocol(atomCoordList, noeConstrList, dynamicsEngine, noeForceField, coolingScheme, rp_force_const=1):
