...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:25:40 2015
  from data model element ccpnmr.AnalysisProfile revision ?
...
class AnalysisProfile(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element ccpnmr.AnalysisProfile.AnalysisProfile revision ?
  _metaclass = metaPackage.getElement('AnalysisProfile')
  _packageName = 'ccpnmr.AnalysisProfile'
  _packageShortName = 'ANAP'
  _fieldNames = ('applicationData', 'bgColor', 'className', 'createdBy', 'fgColor', 'fieldNames', 'font', 'graphicsHandler', 'guid', 'inConstructor', 'isDeleted', 'isLoaded', 'isModifiable', 'isModified', 'isReading', 'lastUnlockedBy', 'metaclass', 'name', 'packageName', 'packageShortName', 'panView', 'qualifiedName', 'sendBugReports', 'transientDialogs', 'transientWindows', 'twoCharShortcuts', 'useCrosshair', 'useGlobalShortcuts', 'userEmail', 'userName', 'userOrganisation', 'webBrowser', 'access', 'activeAccess', 'activeRepositories', 'colorSchemes', 'macros', 'marksColor', 'memopsRoot', 'packageLocator', 'parent', 'refExpProfiles', 'residueProfiles', 'root', 'rulersColor', 'topObject',)
  ...
  def __init__(self, parent, **attrlinks):
    ...
    try:
      ...
      dataDict['userEmail'] = None
      dataDict['userName'] = None
      dataDict['userOrganisation'] = None
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      value = dataDict.get('sendBugReports')
      if (not (value in ['yes', 'no', 'maybe'])):
        raise ApiError("""%s.checkValid: sendBugReports:
         memops.Implementation.ThreeValueAnswer input is not in enumeration ['yes', 'no', 'maybe']""" % self.qualifiedName
         + ": %s" % (value,)
        )

      if (not (len(value.split()) == 1)):
        raise ApiError("""%s.checkValid: sendBugReports:
         ThreeValueAnswer constraint contains_no_white_space violated by value""" % self.qualifiedName
         + ": %s" % (value,)
        )
      ...
      value = dataDict.get('userEmail')
      if (value is not None):
        if (isinstance(value, memops.api.Implementation.String.PythonType)):
          pass
        else:
          raise ApiError("""%s.checkValid: userEmail:
      ...
      value = dataDict.get('userOrganisation')
      if (value is not None):
        if (isinstance(value, memops.api.Implementation.String.PythonType)):
          pass
        else:
          raise ApiError("""%s.checkValid: userOrganisation:
           memops.Implementation.Line input is not of a valid type""" % self.qualifiedName
           + ": %s" % (value,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: colorSchemes:
           non-reciprocal link colorSchemes from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: macros:
           non-reciprocal link macros from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: refExpProfiles:
           non-reciprocal link refExpProfiles from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
      ...
      for value in values:
        ...
        if (not (oldSelf is self)):
          raise ApiError("""%s.checkValid: residueProfiles:
           non-reciprocal link residueProfiles from object""" % self.qualifiedName
           + ": %s" % (self,)
          )
  ...
  def getSendBugReports(self):
    """
    Get for ccpnmr.AnalysisProfile.AnalysisProfile.sendBugReports
    """
    dataDict = self.__dict__
    result = dataDict.get('sendBugReports')
    return result
  ...
  def getUserEmail(self):
    """
    Get for ccpnmr.AnalysisProfile.AnalysisProfile.userEmail
    """
    dataDict = self.__dict__
    result = dataDict.get('userEmail')
    return result
  
  def getUserName(self):
    """
    Get for ccpnmr.AnalysisProfile.AnalysisProfile.userName
    """
    dataDict = self.__dict__
  ...
  def getUserOrganisation(self):
    """
    Get for ccpnmr.AnalysisProfile.AnalysisProfile.userOrganisation
    """
    dataDict = self.__dict__
    result = dataDict.get('userOrganisation')
    return result
  ...
  def setSendBugReports(self, value):
    """
    Set for ccpnmr.AnalysisProfile.AnalysisProfile.sendBugReports
    """
    dataDict = self.__dict__
    if (not (value in ['yes', 'no', 'maybe'])):
      raise ApiError("""%s.setSendBugReports:
       memops.Implementation.ThreeValueAnswer input is not in enumeration ['yes', 'no', 'maybe']""" % self.qualifiedName
       + ": %s" % (value,)
      )
    ...
    currentValue = dataDict.get('sendBugReports')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setSendBugReports')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
  ...
  def setUserEmail(self, value):
    """
    Set for ccpnmr.AnalysisProfile.AnalysisProfile.userEmail
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
    ...
    currentValue = dataDict.get('userEmail')
    notInConstructor = not (dataDict.get('inConstructor'))
  ...
  def setUserName(self, value):
    """
    Set for ccpnmr.AnalysisProfile.AnalysisProfile.userName
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
  ...
  def setUserOrganisation(self, value):
    """
    Set for ccpnmr.AnalysisProfile.AnalysisProfile.userOrganisation
    """
    dataDict = self.__dict__
    if (value is not None):
      if (isinstance(value, memops.api.Implementation.String.PythonType)):
        ...
        raise ApiError("""%s.setUserOrganisation:
         memops.Implementation.Line input is not of a valid type""" % self.qualifiedName
         + ": %s" % (value,)
        )
    ...
    currentValue = dataDict.get('userOrganisation')
    notInConstructor = not (dataDict.get('inConstructor'))
    ...
    dataDict['userOrganisation'] = value
    if (notIsReading):
      if (notInConstructor):
        topObject.__dict__['isModified'] = True
    ...
    if ((notInConstructor and notOverride)):
      ...
      ll = _notifies.get('setUserOrganisation')
      if ll:
        for notify in ll:
          if notify not in ll1:
            notify(self)
  ...
  sendBugReports = property(getSendBugReports, setSendBugReports, None,
  r"""Should bug reports be sent? yes (always) no (never) of maybe (ask first)
  """)
  ...
  userEmail = property(getUserEmail, setUserEmail, None,
  r"""Email address of Analysis user. Used for bug reporting, registration 
  etc. as communication address and user identifier
  """)
  
  userName = property(getUserName, setUserName, None,
  r"""Name of Analysis user. Used for bug reporting, registration etc.
  """)
  
  userOrganisation = property(getUserOrganisation, setUserOrganisation, None,
  r"""Name of Analysis user. Used for bug reporting, registration etc.
  """)
...
class ColorScheme(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccpnmr.AnalysisProfile.ColorScheme revision ?
...
class Macro(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccpnmr.AnalysisProfile.Macro revision ?
...
class RefExpProfile(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccpnmr.AnalysisProfile.RefExpProfile revision ?
...
class ResidueProfile(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element ccpnmr.AnalysisProfile.ResidueProfile revision ?
