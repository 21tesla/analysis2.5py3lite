...
class EntryCompletionGui(BasePopup):
    ...
    def __init__(self, root):
        ...
        BasePopup.__init__(self, parent=root, title=PROGRAM_NAME, location="+100+100", class_=self.application.name)
    ...
    def importCnsDistance(self):
        ...
        fileSelectPopup = FileSelectPopup(
            self,
            file_types=fileTypes,
            title="Import CNS distance restraints file",
            dismiss_text="Cancel",
            selected_file_must_exist=True,
            multiSelect=False,
        )
    ...
    def importFastaSeq(self):
        ...
        fileTypes = [FileType("Fasta", ["*.fsa"]), FileType("All", ["*"])]

        fileSelectPopup = FileSelectPopup(
            self,
            file_types=fileTypes,
            title="Import Fasta sequence file",
            dismiss_text="Cancel",
            selected_file_must_exist=True,
            multiSelect=False,
        )
    ...
    def importPdbCoords(self):
        ...
        fileSelectPopup = FileSelectPopup(
            self,
            file_types=fileTypes,
            title="Import PDB coordinates file",
            dismiss_text="Cancel",
            selected_file_must_exist=True,
            multiSelect=False,
        )
    ...
    def setupSoftware(self):
        ...
        methodStore = (
            project.currentMethodStore or project.findFirstMethodStore() or project.newMethodStore(name=project.name)
        )
