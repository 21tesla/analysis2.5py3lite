...
def analyseChemicalShifts(shiftList):
    ...
    for shift in shiftList.measurements:
        ...
        datum = [resonance.serial, resonance.isotopeCode, resName, bmrbMean, randomCoil, dev, shift.value, shift.error]
...
def lookupAtomDeviation(project, ccpCode, atomName, shiftValue, molType=PROTEIN_MOLTYPE):
