...
def psipredCcpn(chain, smooth=1, alphaBias=1.0, betaBias=1.0):
    ...
    ssFile, prettyFile = psipred(seqFileName, psipredDir, prefix, smooth, alphaBias, betaBias, execDir, dataDir)
...
def psipred(seqFile, psipredDir, prefix, smooth=1, alphaBias=1.0, betaBias=1.0, execDir="./bin", dataDir="./data"):
    ...
    data = (psipass2, datP2, smooth, alphaBias, betaBias, ssP2file, ssFile, horizFile)
