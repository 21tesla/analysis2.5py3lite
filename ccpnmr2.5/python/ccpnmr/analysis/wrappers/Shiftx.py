...
def shiftx(structure, atomType=None):
    ...
    from ccpnmr.analysis.core.MoleculeBasic import DEFAULT_ISOTOPES, makeResidueAtomSets
    ...
    for chain in chainDict:
        ...
        if shiftData:
            if not shiftList:
                ...
                shiftList = nmrProject.newShiftList(name="SHIFTX", details=details, isSimulated=True)
