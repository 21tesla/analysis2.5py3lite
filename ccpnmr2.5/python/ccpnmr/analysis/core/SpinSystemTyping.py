...
from ccpnmr.analysis.core.ChemicalShiftBasic import getAtomProbability, getShiftsResidueProbability
...
def searchPosterior(
    spinSystems, cc0, graph=None, numSteps=100000, numBest=20, preserveAssign=0, v=False, progressBar=None
):
