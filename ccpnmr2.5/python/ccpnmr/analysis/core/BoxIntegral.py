...
from memops.universal.BlockData import arrayOfIndex, cumulativeArray, indexOfArray
...
if __name__ == "__main__":
    ...
    for mat, center, boxSize in (
        (mat1d, center1d, boxSize1d),
        (mat2d, center2d, boxSize2d),
        (mat3d, center3d, boxSize3d),
    ):
        dims = boxSize
        print("values before:")
        printMat(mat, dims)
