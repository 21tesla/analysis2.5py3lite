...
from ccpnmr.analysis.core.UnitConverter import ppm2pnt, unit_converter
...
class ResonanceFrame(Frame):
                ...
                for shift in shifts:
                    ...
                    if self.structure and atomSets1:
                        if resonance.resonanceSet:
                            ...
                            dist = getAtomSetsDistance(atomSets1, atomSets2, self.structure, method="noe")
                        else:
                            dist = None
                    else:
                        dist = None
    ...
    def givePossAssignments(self, peakDim, tolerance, ppm):
        ...
        return findMatchingPeakDimShifts(peakDim, aliasing=self.aliasing, tolerance=tolerance, ppm=ppm)
