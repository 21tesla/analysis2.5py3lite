...
class SetupStructureCalcFrame(Frame):
    def __init__(self, parent, application, *args, **kw):
        ...
        self.molSysPulldown = PulldownMenu(
            self, self.changeMolSystem, tipText="Select which molecular system to use in the calculation"
        )
        ...
        self.constraintSetPulldown = PulldownMenu(
            self, self.changeConstraintSet, tipText="Select which set of restraints to use in the calculation"
        )
        ...
        editGetCallbacks = [
            ...
            None,
            self.toggleUse,
            self.toggleFilterViol,
            self.toggleKeepAssign,
            self.toggleAmbig,
            self.getShiftList,
        ]
    ...
    def getAriaData(self):
        ...
        for obj in self.scrolledMatrix.objectList:
            ...
            if className == "PeakList":
                ...
                datum = {
                    "shifts": {KEY_ID: getObjectKeyString(shiftList)},
                    "peaks": {KEY_ID: key},
        ...
        dict = {
            KEY_GENERAL: {"project_name": self.project.name},
