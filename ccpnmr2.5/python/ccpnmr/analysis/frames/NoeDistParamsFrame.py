...
from ccpnmr.analysis.core.ConstraintBasic import getIntensityDistanceTable, getMeanPeakIntensity
...
noeDistanceFunctions = ["intensity^-1/6", "intensity^-1/4", "intensity^-1/3", "Distance bins"]
...
class NoeDistParamsFrame(Frame):
    def __init__(
        self, parent, nmrProject, peakList=None, intensityTypeCallback=None, distanceFunctionCallback=None, *args, **kw
    ):
        ...
        self.intensityTypePulldown = PulldownList(
            labelFrame,
            callback=self.changeIntensityType,
            texts=entries,
        ...
        self.distFunctionPulldown = PulldownList(
            labelFrame,
            callback=self.changeDistFunction,
        ...
        self.assignedCheck = CheckButton(
            labelFrame,
            callback=self.toggleUseAssigned,
        ...
        self.refDistEntry = FloatEntry(
            labelFrame,
            text=3.2,
            returnCallback=self.setRefDist,
            width=8,
        ...
        self.lowerErrorEntry = FloatEntry(
            labelFrame,
            text=0.20,
            returnCallback=None,
            width=8,
        ...
        self.upperErrorEntry = FloatEntry(
            labelFrame,
            text=0.20,
            returnCallback=None,
            width=8,
...
class EditNoeClassesFrame(LabelFrame):
    def __init__(self, parent, nmrProject, *args, **kw):
        ...
        tipTexts = [
            "Add a new distance restraint category",
        ...
        self.bottomButtons = ButtonList(self, tipTexts=tipTexts, grid=(row, 0), commands=commands, texts=texts)
        self.copySpecPulldown = PulldownList(
            self, callback=None, grid=(row, 1), tipText="Select spectrum to copy NOE classes from"
        )
