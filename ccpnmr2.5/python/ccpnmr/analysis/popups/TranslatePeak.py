...
class TranslatePeakPopup(BasePopup):
    def __init__(self, parent, fixedPeak, movePeak, *args, **kw):
        ...
        BasePopup.__init__(self, parent=parent, title="Reference By Peak", modal=True, *args, **kw)
    ...
    def body(self, guiFrame):
        ...
        row = 0
        frame = LabelFrame(guiFrame, text="Working Spectra", grid=(row, 0), sticky="ew")
    ...
    def update(self):
        ...
        for peakDim in self.movePeak.sortedPeakDims():
            ...
            datum = [dim, ",".join(isotopes), selectedDim, peakDim.value, refValue, delta]
