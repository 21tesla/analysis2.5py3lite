...
from ccpnmr.analysis.core.PeakDrawUtil import peak_draw_methods
...
class EditPeakDrawParamsPopup(BasePopup):
    ...
    **Caveats & Tips**
    ...
    def body(self, guiParent):
        ...
        tabbedFrame = TabbedFrame(guiParent, options=options, grid=(row, 0), tipTexts=tipTexts)
        ...
        self.spinSystAnnoSelect = CheckButton(
            frame1,
            callback=self.setSpinSystAnno,
            grid=(0, 0),
        ...
        self.resonanceAnnoSelect = CheckButton(
            frame1,
            callback=self.setResonanceAnno,
            grid=(1, 0),
        ...
        self.chainAnnoSelect = CheckButton(
            frame1,
            callback=self.setChainAnno,
            grid=(2, 0),
        ...
        tipText = (
            'Whether to show the molecular system code name in peak annotations, e.g. "MS1:21LeuH,N" or "21LeuH,N"'
        )
        self.molSysAnnoSelect = CheckButton(
            frame1,
            callback=self.setMolSysAnno,
            grid=(3, 0),
        ...
        self.meritAnnoSelect = CheckButton(
            frame1,
            callback=self.setMeritAnno,
            grid=(4, 0),
        ...
        self.detailAnnoSelect = CheckButton(
            frame1,
            callback=self.setDetailAnno,
            grid=(5, 0),
        ...
        self.simpleAnnoSelect = CheckButton(
            frame1,
            callback=self.setSimpleAnnotations,
            grid=(6, 0),
            tipText=tipText,
        ...
        self.updateFullAnnoButton = Button(
            frame1,
            text="Update Full Annotations",
        ...
        tipText = (
            "The width of the displayed peak cross/symbol in screen pixels; the number of pixels from the centre point"
        )
        self.pixel_entry = LabeledEntry(
            frame2,
        ...
        self.intensity_entry = LabeledEntry(
            frame2,
            label="Height scale",
        ...
        self.volume_entry = LabeledEntry(
            frame2,
            label="Volume scale",
        ...
        tipTexts = [
            "The kind of nuclear isotope, as found on the axis if a spectrum window",
        ...
        self.peak_size_table = ScrolledMatrix(
            frame2,
        ...
        self.method_menu = PulldownList(
            frame2,
            texts=peak_draw_methods,
            gridSpan=(1, 2),
            grid=(0, 0),
            tipText=tipText,
            callback=self.setMethod,
        ...
        self.meritGoodEntry = Entry(
            frame3,
            text=analysisProject.meritAnnotationGood,
            width=8,
            grid=(0, 1),
            sticky="ew",
            tipText=tipText,
        ...
        self.meritUglyEntry = Entry(
            frame3,
            text=analysisProject.meritAnnotationMediocre,
            width=8,
            grid=(1, 1),
            sticky="ew",
            tipText=tipText,
        ...
        self.meritBadEntry = Entry(
            frame3,
            text=analysisProject.meritAnnotationBad,
            width=8,
            grid=(2, 1),
            sticky="ew",
            tipText=tipText,
        ...
        setButton = Button(
            frame3,
            text="Set symbols",
            command=self.setMeritAnnotation,
            grid=(3, 0),
            gridSpan=(1, 2),
            tipText=tipText,
            sticky="nsew",
        ...
        buttons = UtilityButtonList(tabbedFrame.sideFrame, grid=(0, 0), helpUrl=self.help_url, sticky="e")
        ...
        self.registerNotify(
            self.changedDoAssignmentAnnotations, "ccpnmr.Analysis.AnalysisProject", "setDoAssignmentAnnotations"
        )
    ...
    def destroy(self):
        ...
        self.unregisterNotify(
            self.changedDoChainAnnotations, "ccpnmr.Analysis.AnalysisProject", "setDoChainAnnotations"
        )
