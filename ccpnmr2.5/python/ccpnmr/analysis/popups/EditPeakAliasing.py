...
class EditPeakAliasingPopup(BasePopup):
    ...
    **Move Aliased Peaks to Their Underlying Resonance Position**
    ...
    def body(self, guiFrame):
        ...
        utilButtons = UtilityButtonList(
            guiFrame, doClone=False, closeCmd=self.close, helpUrl=self.help_url, grid=(0, 1)
        )
        ...
        for func in ("__init__", "delete", "setAnnotation", "setNumAliasing", "setPosition"):
