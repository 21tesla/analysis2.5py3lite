...
from ccpnmr.analysis.core.AssignmentBasic import averageShiftValue, makeResonanceGuiName
...
class EditMeasurementListsPopup(BasePopup):
    ...
    **Caveats & Tips**
    ...
    def body(self, guiFrame):
        ...
        self.experimentPulldown = PulldownList(frame0, callback=self.setExperiment, grid=(0, 1), tipText=tipText)
        ...
        commands = [self.showMeasurements, self.addShiftList, self.makeRandomCoilShiftList, self.deleteMeasurementList]
        self.listButtons = ButtonList(
            frameA, texts=texts, commands=commands, grid=(row, 0), gridSpan=(1, 2), tipTexts=tipTexts
        )
        ...
        self.listPulldown = PulldownList(frame0, callback=self.setMeasurementList, grid=(0, 1), tipText=tipText)
        ...
        justifyList = ["center", "center", "center", "center", "center", "center", "center", "center", "center", "left"]
        colHeadings = ["#", "Resonance", "Value", "SD", "Chain", "Isotope", "Fig of\nMerit", "Peaks", "Details"]
        editWidgets = [
            None,
            None,
            None,
            ...
            None,
            None,
            self.measurementMeritEntry,
            None,
            self.measurementDetailsEntry,
        ]
        editGetCallbacks = [
            None,
            None,
        ...
        commands = [self.showPeaks, self.recalculateMeasurements, self.showResonances, self.deleteMeasurements]
        self.measurementButtons = ButtonList(frameB, texts=texts, grid=(row, 0), commands=commands, tipTexts=tipTexts)

        # Main Frame

        self.bottomButtons = UtilityButtonList(
            tabbedFrame.sideFrame, helpUrl=self.help_url, grid=(0, 0), gridSpan=(1, 2), sticky="e"
        )
    ...
    def administerNotifiers(self, notifyFunc):
        ...
        for func in (
            ...
            "setName",
            "setDipolarRelaxList",
            "setHExchProtectionList",
            "setHExchRateList",
            "setNoeList",
            "setJCouplingList",
            "setRdcList",
            "setShiftAnisotropyList",
            "setShiftDifferenceList",
            "setShiftList",
            "setT1List",
            "setT1RhoList",
            "setT2List",
    ...
    def updateMeasurementListAfter(self, measurementList=None):
        ...
        if (measurementList is None) or (self.experiment is None) or (self.experiment in measurementList.experiments):
    ...
    def getMeasurementListName(self, measurementList):
        ...
        name = measurementList.name or "%d:%s" % (measurementList.serial, measurementList.className)
    ...
    def updateMeasurements(self, measurementList=None):
        ...
        headingList = ["#", "Resonance", "Value", "SD", "Chain", "Isotope", "Fig of\nMerit", "Peaks", "Details"]
        ...
        self.measurementsMatrix.update(
            headingList=headingList, objectList=objectList, textMatrix=textMatrix, tipTexts=tipTexts
        )
