...
class EditResStructuresPopup(BasePopup):
    ...
    def body(self, guiFrame):
        ...
        self.constrSetPulldown = PulldownMenu(
            guiFrame, self.changeConstraintSet, constraintSetNames, selected_index=index, do_initial_callback=False
        )
        ...
        self.bottomButtons = UtilityButtonList(
            guiFrame, texts=texts, expands=False, commands=commands, helpUrl=self.help_url
        )
