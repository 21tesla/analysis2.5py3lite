...
#
from ccpnmr.format.webServer.Util import AuthController, is_current_session_user
...
class Convert:
    ...
    def fcOutputPage(self):
        ...
        return mytemplate.render(fcName="FormatConverter", fcWorld="planet of cherries")
...
if __name__ == "__main__":
    ...
    conf = {
        "/css": {"tools.staticdir.on": True, "tools.staticdir.dir": os.path.join(current_dir, "data", "css")},
        "/images": {"tools.staticdir.on": True, "tools.staticdir.dir": os.path.join(current_dir, "data", "images")},
        "/convert/css": {"tools.staticdir.on": True, "tools.staticdir.dir": os.path.join(current_dir, "data", "css")},
        "/convert/images": {
        ...
        "/convertSession/images": {
            "tools.staticdir.on": True,
            "tools.staticdir.dir": os.path.join(current_dir, "data", "images"),
        },
        "/auth/css": {"tools.staticdir.on": True, "tools.staticdir.dir": os.path.join(current_dir, "data", "css")},
        "/auth/images": {
            "tools.staticdir.on": True,
            "tools.staticdir.dir": os.path.join(current_dir, "data", "images"),
        },
