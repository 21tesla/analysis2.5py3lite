...
class Mol2Format(DataFormat):
    def setFormat(self):
        ...
        self.bondTypeRawToCcpn = {"1": "single", "2": "double", "3": "triple", "am": "singleplanar", "ar": "aromatic"}
    ...
    def convertRawBondType(self, rawBondType):
        ...
        if rawBondType in self.bondTypeRawToCcpn:
    ...
    def convertRawMolType(self, rawMolType):
        ...
        if rawMolType in self.molTypeRawToCcpn:
    ...
    def setRawChemComp(self):
        ...
        if molType in self.molTypeCcpnToRaw:
            rawMolType = self.molTypeCcpnToRaw[molType]
        else:
            rawMolType = "SMALL"

        self.rawChemComp = self.chemCompsIO.Mol2ChemComp(
            self.chemCompFile, name, [], [], {}, molType=rawMolType, overallCharge=self.chemCompVar.formalCharge
        )
    ...
    def setRawChemCompAtom(self, atomSerial, rawAtomName, x, y, z, rawAtomType, charge, chemCompCode):
        ...
        atomInfo = {
            ...
            "y": y,
            "z": z,
            "atomType": rawAtomType,
            "charge": charge,
            "substName": chemCompCode.upper(),
            "substId": 1,
            "atomStatus": "****",
        }
    ...
    def setRawChemCompBond(self, atomSerial1, atomSerial2, bondType):
        ...
        if bondType in self.bondTypeCcpnToRaw:
            rawBondType = self.bondTypeCcpnToRaw[bondType]
        else:
            # Default to unknown!
            rawBondType = "un"

        self.rawChemComp.bonds.append(
            self.chemCompsIO.Mol2Bond(self.rawChemComp, atomSerial1, atomSerial2, rawBondType, "")
        )
