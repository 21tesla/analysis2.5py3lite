from ccp.general.Constants import code1LetterToCcpCodeDict, standardResidueCcpCodes
...
class SequenceCompare:
        ...
        for resonance in resonances:
            ...
            if not resonanceLinked:
                ...
                resLabelAppData = resonance.findFirstApplicationData(
                    application=importFormatName, keyword="origResLabel"
                )
                if resLabelAppData:
                ...
                for resName in resNames:
                    ...
                    if seqCode != None:
                        ...
                        if chainCode not in self.formatFileChainDict:
    ...
    def createFormatFileChainInformation(self):
        ...
        for formatChainCode in formatChainCodes:
            ...
            for seqCodeKey in seqCodeKeys:
                ...
                formatSeqList.append(
                    (
                        seqCodeKey[0],
                        self.formatFileResidueDict[formatChainCode][seqCodeKey][0],
                        self.formatFileResidueDict[formatChainCode][seqCodeKey][1],
                    )
                )
    ...
    def getAlignInfo(self, sequences):
        ...
        align = AlignNeedlemanWunsch(
            sequences[0], sequences[1], verbosity=1, compareToUncertain=self.compareToUncertain
        )
        # align.make_graph()
        # align.searchPaths()
        # align.printScores()
