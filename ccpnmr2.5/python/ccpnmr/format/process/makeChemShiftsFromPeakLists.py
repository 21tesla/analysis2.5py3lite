...
def createChemShifts(
    ...
    for nucl, defValue in (("1H", 0.002), ("13C", 0.1), ("15N", 0.1)):
        if nucl not in defaultShiftError:
            ...
            for peakDim in peak.sortedPeakDims():
                ...
                if useAllContribs == 0 and len(peakDimContribs) > 1:
                    ...
                    if not sameShiftGroup:
                        ...
                        print(
                            "  Warning: ignoring peakDim %d for peak %d... more than one resonance contribution"
                ...
                for peakDimContrib in peakDimContribs:
                    ...
                    if resonance not in resonanceChemShifts:
    ...
    for resonance in resonanceChemShifts.keys():
        ...
        if standardDev == None:
            if resonance.isotopeCode in defaultShiftError:
        ...
        if not shift:
            ...
            if (
                shift.value + allowedErrorMargin < chemShiftAverage
                or chemShiftAverage < shift.value - allowedErrorMargin
            ):
