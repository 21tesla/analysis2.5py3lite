...
from ccpnmr.format.general.Constants import chemShiftClasses
...
def makeChemShiftSelections(guiParent, chains, chemShiftList, verbose=0):
            ...
            for atom in residue.sortedAtoms():
                ...
                for chemShiftClass in atomChemShiftClasses.keys():
                    ...
                    if atomFound:
                        ...
                        if chemShiftClass not in results:
    ...
    if verbose:
        ...
        for chemShiftClass in chemShiftResultClasses:
            ...
            print(
                "  %-20s: %6.2f found (%d/%d total)"
                % (chemShiftClass, percentage, results[chemShiftClass][1], results[chemShiftClass][0])
            )
