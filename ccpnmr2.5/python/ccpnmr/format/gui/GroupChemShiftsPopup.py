...
class GroupChemShiftsPopup(BasePopup):
    ...
    def __init__(self, parent, project):
        ...
        BasePopup.__init__(
            self,
            parent=parent,
            title="Project '%s': " % project.name + "Group chemical shift values",
            modal=False,
            transient=True,
        )
    ...
    def body(self, master):
        ...
        self.shiftListSelect = PulldownMenu(
            master, entries=self.shiftListLabels, callback=self.setupPercentageFrame, do_initial_callback=False
        )
    ...
    def setupPercentageFrame(self, listIndex, shiftListLabel):
        ...
        if hasattr(self, "shiftListSelect"):
            if hasattr(self.shiftListSelect, "entries") and tuple(self.shiftListLabels) != tuple(
                self.shiftListSelect.entries
            ):  # HACK
