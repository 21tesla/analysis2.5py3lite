...
class WriteBmrbChemShiftDepPopup(BasePopup):
    ...
    def __init__(self, parent, project):
        ...
        BasePopup.__init__(
            self,
            parent=parent,
            title="Project '%s': " % project.name + "Write BMRB chemical shift deposition file",
            modal=False,
            transient=True,
        )
    ...
    def body(self, master):
        ...
        self.shiftListSelect = PulldownMenu(
            master, entries=self.shiftLists, callback=self.setChainList, do_initial_callback=False
        )
