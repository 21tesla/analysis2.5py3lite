...
class ResonanceSelectPopup(BasePopup):
    def __init__(
        self, parent, resonanceList, resonanceDict, code3Letter, resName, helpText, multi, title="Select resonances"
    ):
    ...
    def body(self, master):
        ...
        row = row + 1
        self.list = ScrolledListbox(
            master, width=50, height=5, selectmode=self.selectmode, initial_list=self.resonanceList
        )
