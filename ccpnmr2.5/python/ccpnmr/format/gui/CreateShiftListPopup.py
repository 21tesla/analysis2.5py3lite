...
class CreateShiftListPopup(BasePopup):
    ...
    def __init__(self, parent, project):
        ...
        BasePopup.__init__(
            self,
            parent=parent,
            title="Project '%s': " % project.name + "Create shift list from peak lists",
            modal=False,
            transient=True,
        )
    ...
    def body(self, master):
        ...
        self.peakListBox = ScrolledListbox(
            master, width=50, height=5, selectmode=Tkinter.MULTIPLE, initial_list=peakListLabels
        )
