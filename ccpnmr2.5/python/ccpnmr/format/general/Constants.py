...
Copyright (C) 2008-2010 Wim Vranken (European Bioinformatics Institute)
...
for tag in chemShiftRefRatios:
    INDIRECT_FREQ_CONV[tag] = 100.0 * chemShiftRefRatios[tag]
...
commonNmrActiveIsotopes = {"H": 1, "C": 13, "N": 15, "P": 31}
...
rawToCcpnAttrNameDict = {"point": "position", "pointDev": "positionError", "ppm": "value", "ppmDev": "valueError"}
...
chemShiftClasses = {
    "protein": {
        "N": {"15N backbone": [["N"], []], "15N sidechain": [[], ["N"]]},
        "C": {
            "13C CO": [["C"], []],
            "13C CA": [["CA"], []],
            "13C CB": [["CB"], []],
...
formatNamingDict = {
    ...
    ("gromacs", None): "IUPAC",
    ("gromos", None): "PDB",
    ("mardigras", None): "PDB",  # Probably not correct.
    ...
    ("nmrView", None): "XPLOR",
    ("pales", None): "IUPAC",  # Pales is naming system agnostic TODO add other naming systems?
    ...
    ("sparky", None): "DIANA",
    ("talos", None): "XPLOR",
    ("targetedAcquisition", None): "IUPAC",
    ("xeasy", None): "DIANA",
}
...
for namingSystemName in formatNamingDict.values():
    if namingSystemName not in namingSystemNames:
...
formatComponents = {
    ...
    "combined": [["Chemical shifts and peaks", "shiftsAndPeaks"]],
}
...
IoSetupList = [
    [
        ...
        "writeSequence",
        {
            ...
            "fasta": ["fasta.seq", 1, 1, [], []],
            "gromos": ["gromos.gro", 1, 0, [], []],
            "mars": ["mars.seq", 1, 1, [], []],
            "mmCif": ["project.cif", 1, 0, [], []],
        ...
        [
            ...
            [
                "SelectionListWithNone",
                "molSystem",
                "Use existing molecular system:",
                "project.sortedMolSystems()",
                None,
            ],
            ...
            ["CheckButton", "autoCreateChemComps", "Automatically create chemComps if atom names available:", 0, None],
        ...
        [
            [
                "MultiSelectionList",
                "chains",
                "Select chains to export:",
                "project.sortedMolSystems().sortedChains()",
                None,
            ],
    ...
    [
        ...
        [
            [
                "SelectionList",
                "chemCompVar",
                "Select chemCompVar to export:",
                "project.sortedMolSystems().sortedChains().sortedResidues().chemCompVar",
                None,
            ],
    ...
    [
        ...
        [
            ...
            [
                "SelectionListWithNone",
                "structureEnsemble",
                "Use existing structure ensemble:",
                "project.currentNmrProject.sortedStructureEnsembles()",
                None,
            ],
            [
                "SelectionListWithNone",
                "strucGen",
                "Use existing structure generation:",
                "project.currentNmrProject.sortedStructureGenerations()",
                None,
            ],
        ...
        [
            [
                ...
                "project.sortedMolSystems().sortedStructureEnsembles().sortedModels()",
                None,
            ],
    ...
    [
        ...
        [
            ...
            [
                "MultiSelectionList",
                "experiments",
                "Link to NMR experiments:",
                "project.currentNmrProject.sortedExperiments()",
                None,
            ],
    ...
    [
        ...
        "writeShifts",
        {
            ...
            "autoAssign": [
                ...
                1,
                0,
                [["CheckButton", "getSeqFlag", "Import sequence from file:", 0, None]],
                [],
            ],
            "cns": ["file.ppm", 1, 1, [], []],
            "cosmos": ["cosmos.cod", 0, 1, [], []],
            "csi": ["data.csi", 1, 1, [], []],
            "cyana": ["", "XEasy format", "XEasy format", [], []],
            ...
            "shifty": ["shifts.tab", 1, 1, [], []],
            "sparky": ["sparky.ppm", 1, 1, [], []],
            "talos": ["project.tab", 1, 1, [], []],
            "targetedAcquisition": ["TAassignment.ta", 1, 0, [], []],
            "xeasy": ["xeasy.prot", 1, 1, [], [["CheckButton", "cyana21Naming", "Use CYANA 2.1 atom names:", 0, None]]],
        },
        [
            ...
            [
                "SelectionListWithNone",
                "measurementList",
                "Add to existing shift list:",
                "project.currentNmrProject.findAllMeasurementLists(className = 'ShiftList')",
                None,
            ],
    ...
    [
        ...
        "writePeaks",
        {
            "ansig": [
                ...
                [
                    [
                        "MultiSelectionList",
                        "peakLists",
                        "Select peak lists to export:",
                        "project.currentNmrProject.sortedExperiments().sortedDataSources().sortedPeakLists()",
                        None,
                    ],
                    [
                        "IntEntry",
                        "forceNumDim",
                        "Force number dimensions in output file (0 for automatic setting):",
                        0,
                        None,
                    ],
                ],
            ...
            "marvin": [
                ...
                0,
                [
                    ["FloatEntry", "probabilityCutoff", "Set probability cutoff:", 0.0, None],
            ...
            "nmrDraw": [
                ...
                1,
                1,
                [["CheckButton", "usePointsInfo", "Import width info as points:", 0, None]],
            ...
            "nmrView": [
                ...
                [
                    ...
                    [
                        "FileButton",
                        "processingParsFile",
                        "Spectrum parameter file:",
                        "Select file (optional)",
                        {"component": "processingPars"},
                    ],
                ],
                [
            ...
            "sparky": [
                ...
                [
                    [
                        "MultiSelectionList",
                        "volumeIntensityType",
                        "Intensity and/or volume export to file:",
                        [volume_kw, height_kw],
                        None,
                    ]
                ],
            ...
            "xeasy": [
                ...
                1,
                [
                    ["CheckButton", "cyanaFormat", "Read as CYANA format:", 0, None],
                    ["CheckButton", "forceHeight", "Force volumes as height values:", 0, None],
                ],
                [
        ...
        [
            ...
            [
                ...
                "project.currentNmrProject.sortedExperiments().sortedDataSources()",
                None,
            ],
            [
                "SelectionListWithNone",
                "peakList",
                "Overwrite existing peaklist:",
                "project.currentNmrProject.sortedExperiments().sortedDataSources().sortedPeakLists()",
                None,
            ],
    ...
    [
        ...
        "writeDistanceConstraints",
        {
            "amber": [
                ...
                1,
                0,
                [["FileButton", "coordFile", "Coordinate file (for atom names):", "Select file (required)", None]],
                [],
            ],
            "aqua": ["aqua.noe", 1, 1, [], []],
            "cns": [
        ...
        [
            ...
            [
                "SelectionListWithNone",
                "nmrConstraintStore",
                "Add to NMR constraint store:",
                "project.sortedNmrConstraintStores()",
                None,
            ],
            [
                "SelectionListWithNone",
                ...
                "project.currentNmrProject.sortedStructureGenerations().nmrConstraintStore.findAllConstraintLists(className = 'DistanceConstraintList')",
                None,
            ],
            ["CheckButton", "resonanceMatching", "Match existing resonances:", 1, None],
            ["CheckButton", "minimalPrompts", "Minimal interaction:", 0, None],
        ...
        [
            [
                "SelectionList",
                "constraintList",
                "Select distance constraint list to export:",
                "project.currentNmrProject.sortedNmrConstraintStores().findAllConstraintLists(className = 'DistanceConstraintList')",
                None,
            ],
    ...
    [
        ...
        [
            ...
            [
                ...
                "constraintList",
                "Add to constraint list:",
                "project.currentNmrProject.sortedStructureGenerations().nmrConstraintStore.findAllConstraintLists(className = 'HBondConstraintList')",
                None,
            ],
            ["CheckButton", "resonanceMatching", "Match existing resonances:", 1, None],
            ["CheckButton", "minimalPrompts", "Minimal interaction:", 0, None],
        ...
        [
            [
                "SelectionList",
                "constraintList",
                "Select H-bond constraint list to export:",
                "project.currentNmrProject.sortedNmrConstraintStores().findAllConstraintLists(className = 'HBondConstraintList')",
                None,
            ],
    ...
    [
            ...
            "talos": [
                ...
                [
                    [
                        "MultiSelectionList",
                        "validClasses",
                        "Classes for valid constraint:",
                        ["Good", "New", "Warn", "Dyn", "Strong", "Generous", "None"],
                        None,
                    ],
                    ...
                    [
                        "FloatEntry",
                        "multiplyDeviation",
                        "Multiplication factor to convert deviation in constraint range:",
                        2.0,
                        None,
                    ],
                ],
        ...
        [
            ...
            [
                ...
                "constraintList",
                "Add to constraint list:",
                "project.currentNmrProject.sortedStructureGenerations().nmrConstraintStore.findAllConstraintLists(className = 'DihedralConstraintList')",
                None,
            ],
            ["CheckButton", "resonanceMatching", "Match existing resonances:", 1, None],
            ["CheckButton", "minimalPrompts", "Minimal interaction:", 0, None],
        ...
        [
            [
                "SelectionList",
                "constraintList",
                "Select dihedral constraint list to export:",
                "project.currentNmrProject.sortedNmrConstraintStores().findAllConstraintLists(className = 'DihedralConstraintList')",
                None,
            ],
    ...
    [
            ...
            "cns": [
                ...
                [
                    ...
                    [
                        "StringEntry",
                        "refFrameSegId",
                        "The segment Id for the reference frame:",
                        defaultMolCode,
                        {"width": 1},
                    ],
                    ["CheckButton", "writeWeight", "Export value for restraint weight:", 0, None],
                    ["StringEntry", "filterAtomNames", "Only include atom names:", "", {"width": 10}],
                ],
            ],
            "dyana": [
                "rdcs",
                ...
                1,
                [],
                [["CheckButton", "singleAtom", "Write out with single atom for each RDC:", 0, None]],
            ],
            "cyana": [
                "rdcs",
                1,
        ...
        [
            ...
            [
                ...
                "constraintList",
                "Add to constraint list:",
                "project.currentNmrProject.sortedStructureGenerations().nmrConstraintStore.findAllConstraintLists(className = 'RdcConstraintList')",
                None,
            ],
            ["CheckButton", "resonanceMatching", "Match existing resonances:", 1, None],
            ["CheckButton", "minimalPrompts", "Minimal interaction:", 0, None],
        ...
        [
            [
                "SelectionList",
                "constraintList",
                "Select RDC constraint list to export:",
                "project.currentNmrProject.sortedNmrConstraintStores().findAllConstraintLists(className = 'RdcConstraintList')",
                None,
            ],
            ["FileButton", "fileName", "Name of export RDC constraints file:", "Select export file", None],
            ["CheckButton", "negateValues", "Negate exported coupling constant values:", 0, None],
            ["CheckButton", "sortForExport", "Sort constraints for export:", 0, None],
            ["CheckButton", "useOriginalResNames", "Use original resonance names:", 0, None],
            ["CheckButton", "compressResonances", "Compress names in output:", 1, None],
            ["CheckButton", "useOriginalData", "Use original data:", 0, None],
    ...
    [
        ...
        [
            [
                "FileButton",
                "fileName",
                "Chemical shift anisotropy (CSA) constraints file to import:",
                "Select file",
                None,
            ],
            [
            ...
            [
                ...
                "constraintList",
                "Add to constraint list:",
                "project.currentNmrProject.sortedStructureGenerations().nmrConstraintStore.findAllConstraintLists(className = 'ChemShiftConstraintList')",
                None,
            ],
            ["CheckButton", "resonanceMatching", "Match existing resonances:", 1, None],
            ["CheckButton", "minimalPrompts", "Minimal interaction:", 0, None],
        ...
        [
            [
                "SelectionList",
                "constraintList",
                "Select chemical shift anisotropy (CSA) constraint list to export:",
                "project.currentNmrProject.sortedNmrConstraintStores().findAllConstraintLists(className = 'ChemShiftConstraintList')",
                None,
            ],
    ...
    [
        ...
        [
            ...
            [
                ...
                "constraintList",
                "Add to constraint list:",
                "project.currentNmrProject.sortedStructureGenerations().nmrConstraintStore.findAllConstraintLists(className = 'JCouplingConstraintList')",
                None,
            ],
            ["CheckButton", "resonanceMatching", "Match existing resonances:", 1, None],
            ["CheckButton", "minimalPrompts", "Minimal interaction:", 0, None],
        ...
        [
            [
                "SelectionList",
                "constraintList",
                "Select J coupling constraint list to export:",
                "project.currentNmrProject.sortedNmrConstraintStores().findAllConstraintLists(className = 'JCouplingConstraintList')",
                None,
            ],
    ...
    [
        ...
        [
            ...
            [
                ...
                "fidDataSource",
                "Use FID dataSource:",
                "project.currentNmrProject.sortedExperiments().findAllDataSources(dataType = 'FID')",
                None,
            ],
    ...
    [
        ...
        [
            [
                "SelectionList",
                "freqDataSource",
                "Select FREQ data source to export:",
                "project.currentNmrProject.sortedExperiments().findAllDataSources(dataType = 'processed')",
                None,
            ],
    ...
    [
        ...
        "",
        {
            "mars": [
                ...
                1,
                0,
                [["SelectionList", "reliabilityCutoff", "Reliability cutoff:", ["H", "M", "L"], None]],
                [],
            ]
        },
        [
            ...
            [
                "SelectionList",
                "chain",
                "Select chain to link imported data to:",
                "project.sortedMolSystems().sortedChains()",
                None,
            ],
            ["CheckButton", "minimalPrompts", "Minimal interaction:", 0, None],
    ...
    [
        ...
        "writeProject",
        {
            ...
            "cosmos": [
                ...
                [
                    [
                        "SelectionList",
                        "projectType",
                        "Project file (COO for coord/shifts, COD for restraints/shifts):",
                        ["COO", "COD"],
                        None,
                    ],
                    [
            ...
            "mars": [
                ...
                [
                    ...
                    [
                        "SelectionList",
                        "shiftList",
                        "Select shift list to use in the MARS input:",
                        "project.currentNmrProject.findAllMeasurementLists(className = 'ShiftList')",
                        None,
                    ],
            ...
            "nmrStar": [
                ...
                [
                    [
                        ...
                        "project.currentNmrEntryStore.sortedEntries()",
                        None,
                    ],
                    ["CheckButton", "useOriginalData", "Use original data:", 0, None],
                ],
            ...
            "sparky": [
                ...
                1,
                1,
                [["CheckButton", "ignoreShifts", "Ignore reading of chemical shifts:", 0, None]],
                [
                    [
                        "SelectionList",
                        "entry",
                    ...
                    [
                        "SelectionList",
                        "molSystem",
                        "Select molecular system to export:",
                        "project.sortedMolSystems()",
                        None,
                    ],
                    ["CheckButton", "useOriginalResNames", "Use original resonance names:", 0, None],
            ...
            "xeasy": [
                ...
                [
                    ...
                    [
                        "FileButton",
                        "peakAssignmentFile",
                        "Peak assignment file to import:",
                        "Select file",
                        {"component": "peakAssignments"},
                    ],
                ],
                [],
            ],
...
fileTypeDict = {
    ...
    "hExchProtection": {"generic": ["*.str"], "nmrStar": ["*.str"]},
    "hExchRates": {"generic": ["*.str"], "nmrStar": ["*.str"]},
    "shiftAnisotropy": {"generic": ["*.str"], "nmrStar": ["*.str"]},
    "shifts": {
        "generic": ["*.ppm", "*.prot"],
        "auremol": ["*.meta"],
        "autoAssign": ["*.out"],
        ...
        "sparky": ["*.ppm"],
        "talos": ["*.tab"],
        "targetedAcquisition": ["*.ta"],
        "xeasy": ["*.prot"],
    },
    "t1Relax": {"generic": ["*.str"], "nmrStar": ["*.str"]},
    "t1RhoRelax": {"generic": ["*.str"], "nmrStar": ["*.str"]},
    "t2Relax": {"generic": ["*.str"], "nmrStar": ["*.str"]},
    "noe": {"generic": ["*.str"], "nmrStar": ["*.str"]},
    "peaks": {
        "generic": ["*.xpk", "*.peaks", "*.tbl", "*.tab"],
        "ansig": ["*.xpk", "*.export"],
        "auremol": ["*.ml"],
        "autoAssign": ["*.pks"],
        "cyana": ["*.peaks"],
    ...
    "csaConstraints": {"generic": ["*.tbl"], "cns": ["*.tbl"]},
    "jCouplingConstraints": {"generic": ["*.tbl"], "cns": ["*.tbl"]},
    "acqPars": {"generic": ["acqu*", "procpar"], "bruker": ["acqu*"], "varian": ["procpar"]},
    "acqPars": {"generic": ["acqu*", "procpar"], "bruker": ["acqu*"], "varian": ["procpar"]},
    "processingPars": {"azara": ["*.par"], "bruker": ["proc*"], "nmrPipe": ["*.com"], "nmrView": ["*.par"]},
    "processingScript": {"azara": ["*.scr"], "nmrPipe": ["*.com"]},
...
oldToNewExpDict = {
    ...
    # Tocsy spectra
    # -------------
    "tocsy.hh": ("H_H.relayed", "H_H.relayed"),
    "tocsy_HcCh.hc": ("HC_CH.relayed", "hC_cH.relayed"),
    "tocsy_HCCH.hhc": ("HC_CH.relayed", "HC_cH.relayed"),
    "tocsy_CcconH.hc": ("HC_CCONH.relayed", "hC_cconH.relayed"),
    "tocsy_CccoNH.hcn": ("HC_CCONH.relayed", "hC_ccoNH.relayed"),
    "tocsy_HccoNH.hhn": ("HC_CCONH.relayed", "Hc_ccoNH.relayed"),
    "tocsy_CcNH.hcn": ("HC_CNH.relayed", "hC_cNH.relayed"),
    "tocsy_HcNH.hhn": ("HC_CNH.relayed", "Hc_cNH.relayed"),
    # Cosy spectra
    # ------------
    ...
    # Noesy spectra
    #
    "noesy.hh": ("H_H.through-space", "H_H.through-space"),
    "noesy_hsqc_HCH.hhc": ("H[C]_H.through-space", "H_H[C].through-space"),
    "noesy_hsqc_HNH.hhn": ("H[N]_H.through-space", "H_H[N].through-space"),
    "noesy_hsqc_HXH.hhx": ("H[{N|C}]_H.through-space", "H_H[{N|C}].through-space"),
    "noesy_hsqc_HCCH.hhcc": ("H[C]_H[C].through-space", "H[C]_H[C].through-space"),
    "noesy_hsqc_HNNH.hhnn": ("H[N]_H[N].through-space", "H[N]_H[N].through-space"),
    "noesy_hsqc_HCNH.hhcn": ("H[N]_H[C].through-space", "H[C]_H[N].through-space"),
    "noesy_hsqc_HNCH.hhnc": ("H[N]_H[C].through-space", "H[N]_H[C].through-space"),
}
...
softwareDefinitions = {
    ...
    "ccpNmr": {
        ...
        "methods": {"Peak integration": ["Volume", "Intensity"], "Peak picking": ["Automatic and manual"]},
    },
    # TODO: if making changes here, also do for cyana!
    "xeasy": {
        "version": "any",
        "tasks": ["Spectrum display", "Spectrum analysis"],
        "methods": {
    ...
    "azara": {"version": "any", "tasks": ["Spectrum display", "Spectrum analysis"], "methods": {}},
    "ansig": {
        "version": "any",
        "tasks": ["Spectrum display", "Spectrum analysis"],
        "methods": {"Peak integration": ["Volume"], "Peak picking": ["Automatic and manual"]},
    },
    "nmrPipe": {"version": "any", "tasks": ["Spectrum processing"], "methods": {}},
    "pipp": {
        "version": "any",
        "tasks": ["Spectrum analysis"],
        "methods": {"Peak integration": ["Intensity"], "Peak picking": ["Automatic and manual"]},
    },
    "pronto": {
        "version": "any",
        "tasks": ["Spectrum analysis"],
...
varianAcqOrdInfo = {
    3: [
        ["d3,d2,ph2,ph (normal)", "d3,d2,ph,ph2"],
        [("dim3", "dim2", "phase2", "phase1"), ("dim3", "dim2", "phase1", "phase2")],
    ],
    4: [
        ["d4,d3,d2,ph3,ph2,ph (normal)", "d4,d3,d2,ph,ph2,ph3"],
        [
            ("dim4", "dim3", "dim2", "phase3", "phase2", "phase1"),
            ("dim4", "dim3", "dim2", "phase1", "phase2", "phase3"),
        ],
    ],
}
