...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:26:10 2015
...
class MolSystemSymmetrySet(memops.api.Implementation.TopObject):
  ...
  """
  #   from data model element molsim.Symmetry.MolSystemSymmetrySet revision ?
...
class Segment(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element molsim.Symmetry.Segment revision ?
...
a multichain MolSystem.
  """
  #   from data model element molsim.Symmetry.Symmetry revision ?
  ...
  def sortedHaddockRuns(self):
    """
    Sorted for molsim.Symmetry.Symmetry.haddockRuns
    """
    dataDict = self.__dict__
    root = dataDict.get('topObject').__dict__.get('memopsRoot')
    root.refreshTopObjects('utrecht.Haddock')
