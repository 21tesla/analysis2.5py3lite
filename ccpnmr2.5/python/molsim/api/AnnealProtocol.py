...
Autogenerated by PyFileApiGen revision 1.57.2.1 on Mon Mar  2 17:26:01 2015
  from data model element molsim.AnnealProtocol revision ?
...
general terms.
  """
  #   from data model element molsim.AnnealProtocol.AnnealProtocol revision ?
  ...
  def addHaddockRun(self, value):
    ...
    """
    dataDict = self.__dict__
    from utrecht.api.Haddock import Run as importedType
  ...
  def getSoftware(self):
    ...
    """
    dataDict = self.__dict__
    result = ccp.api.general.Method.Software.getByKey(self.root, (self.methodStoreName, self.application, self.applicationVersion))
    return result
...
class AnnealStage(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element molsim.AnnealProtocol.AnnealStage revision ?
...
refPotentialTerms
  """
  #   from data model element molsim.AnnealProtocol.EnergyTerm revision ?
  ...
  def addHaddockEnergyTerm(self, value):
    ...
    """
    dataDict = self.__dict__
    from utrecht.api.Haddock import HaddockEnergyTerm as importedType
    if (not isinstance(value, importedType)):
  ...
  def checkValid(self, complete=False):
    ...
    if (complete):
      ...
      for value in values:
        from ccp.api.nmr.NmrCalc import EnergyTerm as importedType
        if (not isinstance(value, importedType)):
...
class PotentialScale(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element molsim.AnnealProtocol.PotentialScale revision ?
...
interpretation generally requires reference to the application.
  """
  #   from data model element molsim.AnnealProtocol.RefPotentialTerm revision ?
...
class RefTermParameter(memops.api.Implementation.DataObject):
  ...
  """
  #   from data model element molsim.AnnealProtocol.RefTermParameter revision ?
